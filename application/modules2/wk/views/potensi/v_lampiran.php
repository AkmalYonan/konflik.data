		...
		<table class="table table-condensed table-bordered">
			<thead>
				<tr>
					...
					<th width="250">Multiple Upload Button</th>
					<th>File</th>
				</tr>
			</thead>
			<tbody>
...
<label>Note : File Max 8 Mb(Megabytes)</label>
<br />
<div class="row">
	<div class="col-sm-12">
		<div class="callout callout-info">
			...
			<p align="justify">
				4. Tipe File yang diperbolehkan untuk diupload : docx|doc|pdf|png|jpg|bmp|jpeg|xls|csv|txt|xlsx|zip|rar.
			</p>
		</div>
	</div>
</div>
		...
		var uploader3 = new plupload.Uploader({
			...
			filters : {
				...
				mime_types: [
					...
					{title : "Doc", extensions : "docx,doc"},
					{title : "Presentation", extensions : "pdf,ppt"},
					{title : "Excel", extensions : "xlsx,xls,csv"},
					{title : "Image jpg", extensions : "jpg,jpeg,gif,png"},
				]
			}
		});
