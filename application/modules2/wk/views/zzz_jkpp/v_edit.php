						...
						<div class="row">
							<div class="col-md-6"  >
								<div class="form-group tanggal_proses">
									...
									<div class="input-group">
									<input type="hidden" id="tgl_proses" name="tgl_proses" value="<?=date_format(date_create($data['tgl_proses']),"Y-m-d")?>" />
									<input type="text" id="tgl_proses_selector" class="form-control" value="<?=date_format(date_create($data['tgl_proses']),"d-m-Y")?>" required  />
									<div class="input-group-addon">
										<i class="fa fa-calendar"></i>
									</div>	
									</div>
                        ...
                        <div class="row">
                        	<div class="col-md-6">
                            	<div class="form-group">
									...
									<?php echo form_input('longitude',$data["longitude"],'id="x" placeholder="koordinat -180 sampai 180" data-x="'.$data["longitude"].'" class="form-control required"');?>
                            ...
                            <div class="col-md-6">
                            	<div class="form-group">
									...
									<?php echo form_input('latitude',$data["latitude"],'id="y" placeholder="koordinat -90 sampai 90" data-y="'.$data["latitude"].'" class="form-control required"');?>
									...
									if($this->user_prop):
										...
										if($this->user_kab):
											...
											if($this->user_prop):
												...
												$arrKec	=	m_lookup("KECAMATAN","KD_KECAMATAN","NM_KECAMATAN","KD_PROPINSI={$this->user_prop} and KD_KABUPATEN={$kd_kab}");
											endif;
