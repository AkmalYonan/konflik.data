						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="input-group">
									<input type="hidden" id="tgl_kejadian" name="tgl_kejadian" value="<?=date('Y-m-1')?>" />
									<input type="text" id="tgl_kejadian_selector" class="form-control" value="<?=date('F Y')?>" required  />
						...
						<div class="row">
							<div class="col-md-6"  >
								<div class="form-group tanggal_proses">
									...
									<input type="text" id="tgl_proses_selector" class="form-control" value="<?=date('d-m-Y')?>"  />
									<div class="input-group-addon">
										<i class="fa fa-calendar"></i>
									</div>	
									</div>
									...
									<?php
										...
										if($this->user_prop):
											...
											if($data["kd_propinsi"]):
												...
												if($data["kd_kabupaten"]):
													$arrKec=array(""=>"--Pilih--")+m_lookup("kecamatan","KD_KECAMATAN","NM_KECAMATAN","kd_propinsi='".$data['kd_propinsi']."' and kd_kabupaten='".$data['kd_kabupaten']."'");
												endif;
											endif;
										endif;
