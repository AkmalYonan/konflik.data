...
<?php
	...
	//$sub_title = $this->lookup_category[$category];
	$sub_title = "Import data";
?>
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo $this->module?>"><?=$sub_title?></a></li>
	...
	<div class="row">
    	<div class="col-md-12">
            ...
            <div class="content-toolbar">
                	<a class="btn btn-white" href="<?php echo $this->module?>index/<?=$category?>" data-toggle='tooltip' title="List">
        	...
        	<div>
                <form id="frm" method="post" action="<?php echo $this->module;?>read_import/" enctype="multipart/form-data">
