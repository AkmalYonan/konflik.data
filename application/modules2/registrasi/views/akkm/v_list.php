	...
	<div class="row">
							...
							<form class="form-inline" action="<?=$this->module?>" method="get" id="search_form">
								...
								<!-- <div class="form-group">
									<select name="status" class="form-control">
										<option value="">Statussssssssssss</option>
										<?php foreach($lookup_status_akkm as $k=>$v): ?>
					   			...
					   			<tr>
					   				<th rowspan='2' style="vertical-align: middle;" width="20px"><center>No.</th>
					   					<th rowspan='2' style="vertical-align: middle;" width="70px"><center>ID</th>
					   						...
					   						<!-- <th rowspan='2' style="vertical-align: middle;"><center>Statusbbbbbbbbbbbb</center></th> -->
					   						<th rowspan='2' style="vertical-align: middle;" width="320px"><center>Deskripsi</center></th>
					   						<th rowspan='2' style="vertical-align: middle;"><center>Entry</center></th>
					   						<th rowspan='2' style="vertical-align: middle;"><center>#</center></th>
					   					</tr>
					   					<tr>
					   					...
					   					<?php if(cek_array($arrData)):?>
					   						<?php foreach($arrData as $x=>$val):
					   							...
					   							<tr>
					   								...
					   								<td align='justify'><?=$val["ID"]?></td>
					   								<td align='justify'><?=$val["nama_akkm"]?>
					   								<br />
					   								<span class="text-muted"><em><?=$val['nm_propinsi']?></em>&nbsp;</span><br />
					   								<span class="text-muted"><em><?=$val['nm_kabupaten']?></em>&nbsp;</span>

					   							</td>
					   							<td align='justify'><?=$val["pengampu"]?></td>
					   							<td align='justify'><?=$val["luas"]?></td>
					   							<td align='justify'><?=$val["ekosistem"]?></td>
					   							...
					   							<!-- <td align='justify'>
					   								<span class="label label-primary">
					   										<? if($val["status_akkm"]=="RN"):?>
					   											Registrasi Nasional
					   											<?elseif($val["status_akkm"]=="RI"):?>
				...
				<div id="print_this" class="bg-white hidden">
					<div id="div_excel">
						<div style="text-align:center;font-size:14px;">
							<p>
								<b>  IPCC WGII - DAFTAR LIST DATA AKKM </b>
							</p>
						</div>
						<div class="box-body table-responsive">
							<table class="blek" border="1" style="padding:20px; border-collapse:collapse; width:100%;  border:thin solid;">
		...
		*/
		...
		$("a.print-excel").click(function(e){
			...
			var file="Data_Akkm<?="_".date("YmdHis").".xls";?>";
