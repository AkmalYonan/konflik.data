        	...
        	<div class="box box-widget">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                    	<tr>
                        <th width="20">No.</th>
                        <th class="forder" width="100" rel="date">Jenis</th>
                        <th class="forder" width="300" rel="title">Subject/Nama</th>
                        <th>Deskripsi</th>
                    ...
                    <?php if(cek_array($arrData)):?>
							...
							?>
                            	<tr>
                                    ...
                                    <td rel="date_col" width="150"><?=$this->lookup_map_group[$val['kd_layer']];?></td>
                    				<td rel="title_col"><a href="<?=$url_edit;?>"><?=$val['ur_wilayah'];?></a></td>
