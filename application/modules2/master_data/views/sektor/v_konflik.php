	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                ...
                <div class="box-body">
                <form id="frm" method="post" action="<?php echo $this->module;?>konflik/<?php echo $id;?>">
											<input type="hidden" name="act" id="act" value="update"/>
											<input type="hidden" name="idx" id="kode" value="<?=$data['sektor']['idx']?>"/>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label for="kode_sektor">Kode Sektor</label>
														<input class="form-control required"  readonly type="text" style="width:50%" value="<?=$data['sektor']['kode']?>" />
													</div>
													<div class="form-group">
														<label for="ur_sektor">Nama Sektor</label>
														<input class="form-control required"   readonly placeholder="" type="text" value="<?=$data['sektor']['uraian']?>" >
													</div>
													<div class="form-group">
														<label for="color_sektor">Warna Sektor</label><br />
														<input type="text"  id="color" readonly value="<?=$data['sektor']['color']?>">
													</div>
													<div class="form-group">
														<label for="color_sektor">Konflik</label><br />
	...
	$(function(){
		$("#du-add").click(function(){
			var length = $(".du-item").length;
				var new_el = '<div class="row"><div class="col-md-3" style="margin-bottom:2px;"><div style="position:relative"><input type="text" class="du-item form-control" name="kode[]" ></div></div><div class="col-md-6" style="margin-bottom:2px;"><div style="position:relative"><input type="text" class="du-item form-control" name="uraian[]"></div></div><div class="col-md-2" style="margin-bottom:2px;"><div style="position:relative"> <select name=status[] class="form-control"><option   value="1">Aktif</option><option value="0">Tidak Aktif</option></select></div></div><span class="btn btn-sm du-remove" style="right:0px; top:0px"><i class="fa fa-trash"></i></span></div>';
