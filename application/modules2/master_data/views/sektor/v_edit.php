					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control required" name="kode" readonly type="text" style="width:50%" value="<?=$data['kode']?>" />
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input class="form-control required" style="width:50px" name="order_num" placeholder="" type="text" value="<?=$data["order_num"]?>" />
							</div>
							<!--
							<div class="form-group">
