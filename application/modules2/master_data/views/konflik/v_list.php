        	...
        	<div class="box box-widget">
						  ...
						  <div class="form-group">
                           <select name="sektor" class="form-control">
							...
							<? foreach($sektor as $k=>$v){?>
								<option <?=($_GET['sektor']==$k)? "selected":""?> value ="<?=$k?>"><?=$v?></option>
							<? } ?>
						   </select>
                          </div>
                          <div class="form-group">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            <th width="25">No.</th>
							<th width="150">Sektor</td>
                            <th width="150">Kode Konflik</th>
                            <th>Nama Konflik</th>
                            <th width="100px" class="tc">Status</th>
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $sektor[$value["sektor_id"]]?></td>
