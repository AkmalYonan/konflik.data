					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="sektor_id" class="form-control">
									<? foreach($sektor as $k=>$v){?>
										<option <?=($data['sektor_id']==$v['kode'])? "selected":""?> value="<?=$v['kode']?>"><?=$v['uraian']?></option>
									<? }?>
                            ...
                            <div class="form-group">
								...
								<input class="form-control required" name="order_num" style="width:50px"  placeholder="" type="text" value="<?=$data["order_num"]?>" />
							</div>
						</div>
					</div>
                    <!-- /.col -->
