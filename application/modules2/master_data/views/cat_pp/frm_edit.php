<?
  ...
  $lookup_kategori[1]="Peraturan Perundangan";
  $lookup_kategori[2]="Hasil Penelitian";
?>
<div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="parent_id">Kategori</label>
                        <?=form_dropdown("parent_id",$lookup_kategori,$data["parent_id"],"id='parent_id' class='form-control select2 required'");?>
                      </div><!-- end form group-->
                      	<div class="form-group">
