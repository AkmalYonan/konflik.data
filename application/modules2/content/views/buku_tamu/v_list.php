        	...
        	<div class="box box-widget">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
						...
						<th width="5"></th>
						<th width="10">No.</th>
                        <th class="forder" width="80" rel="date">Tanggal</th>
                        <th class="forder" width="130" rel="title">Subject</th>
                        <th >Uraian</th>
                        <th class="tbldata_header forder">Balasan</th>
                ...
                <tbody>
                    ...
                    <?php if(cek_array($arrData)):?>
							...
							?>
                            	<tr>
									<td>
									<input type="checkbox" name="chkDel[]" value="<?=$val['idx'];?>">
									</td>
                                	<td><?php echo $offset+$x+1?>.</td>
                                    <td rel="date_col" width="150">
									<?=date('d-m-Y h:i:s', strtotime($val['created']));?>
									<?//=$val['created'];?></td>
                    				<td rel="title_col"><a href="<?=$url_edit;?>"><?=$val['subject'];?></a></td>
                    				<td><?=$val['comments'];?></td>
                                    <td><?=$val['reply']?> <br /></td>
									<td><?=$status_badges?></td>
                                     <td align="center">
                                     	<div class="btn-group btn-group-xs">
                                        <a class="btn btn-xs btn-default" href="<?=$this->module?>edit/<?=$id?>" data-toggle='tooltip' title="Edit"><i class="fa fa-search green"></i> reply</a> 
