                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
							...
							<th>Tahapan</th>
							<th align="center" colspan="2">Status Peta</th>
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
									...
									<td style="width:60px;">
										<?php if($val['longitude'] && $val['latitude']): ?>
											<span class="label label-default" title="Koordinat titik"><i class="fa fa-map-marker"></i></span>
										<?php endif; ?>
										<?php if($val['file_peta']): ?>
											<span class="label label-default" title="Polygon (Peta GeoJSON)"><i class="fa fa-square-o"></i></span>
										<?php endif; ?>
									</td>
...
<div id="print_this" class="bg-white hidden">
				<div id="div_excel">
					...
					<b>DAFTAR POTENSI WILAYAH KELOLA<br>SELURUH TAHUN</b>
					<?php else: ?>
					<b>DAFTAR POTENSI WILAYAH KELOLA<br>TAHUN <?=($_GET['tahun']=="")?date('Y'):$_GET['tahun']?></b>
					<?php endif; ?>
					</p>
					</div>
					<div class="box-body table-responsive">
	...
	$(function(){
		...
		*/
		...
		$("a.print-excel").click(function(e){
			...
			var file="Data_potensi<?="_".date("YmdHis").".xls";?>";
