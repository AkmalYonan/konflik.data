...
<script>
	...
	function init(){
		...
		console.log(source);
		<?=$wmsmap;?>
		//L.control.groupedLayers(null,groupedOverlays1).addTo(map);
		L.control.groupedLayers(null, groupedOverlays).addTo(map);
		//source.getLayer("Hutan_Lindung").addTo(map);
	...
	function set_wk_layer(){
		...
		var layer=[
			...
			{"ur_group":"Usulan Masyarakat","json_url":tora_piaps_url_usulan+"&tora=1","ur_layer":"TORA"},
			{"ur_group":"Usulan Masyarakat","json_url":tora_piaps_url_usulan+"&piaps=1","ur_layer":"PS"},
			{"ur_group":"Usulan Masyarakat","json_url":tora_piaps_url_usulan+"&hutan_adat=1","ur_layer":"WILAYAH ADAT"},
			{"ur_group":"Realisasi","json_url":tora_piaps_url_realisasi+"&tora=1","ur_layer":"TORA"},
			{"ur_group":"Realisasi","json_url":tora_piaps_url_realisasi+"&piaps=1","ur_layer":"PS"},
			{"ur_group":"Realisasi","json_url":tora_piaps_url_realisasi+"&hutan_adat=1","ur_layer":"WILAYAH ADAT"}
