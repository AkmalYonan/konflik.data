...
<script>
	...
	$(document).ready(function(){
		...
		$("#check_tora1").on("change",function(){
			...
			initial_tora_piaps(tora_val,piaps_val);
	...
	var wikera_gfi = wms_url+'cgi-bin/mapserv?map=/map/gfi.map&';
	...
	function init(){
		...
		initial_tora_piaps(false,false);
	...
	function getData(kd_prop,id_kabupaten,sektor,konflik,tahun){
		...
		var	tahun_val	=	tahun?tahun:$("#tahun").val();
		legendTheme();
		...
		$.getJSON(theme['json_url']+q,function(data){
			...
			if(data.konflik>0){
				for(var a = 0; a < data.loops.length; a++){
					buatTabel += "<li class='list-group-item'><p align='justify' style='margin-right:10px;'><a href='data_detail/index/"+ (data.loops[a].idx) + "'>" + (data.loops[a].judul) + "</a></p></li>";
				}
			}else{
				buatTabel += "<li class='list-group-item'><font color='#ff0000'>Tidak Ada Data</font></li>";
			}
	...
	function initial_tora_piaps(val_tora,val_piaps){
		
		var value_tora		=	val_tora==1?val_tora:false;
		var value_piaps		=	val_piaps==1?val_piaps:false;
		
		
		var url_key	=	"&tora="+value_tora+"&piaps="+value_piaps;
	...
	function onEachFeatureTora(feature, layer) {
		if (feature.properties){
			...
			if(jenis_wilayah=="TORA"){
				...
				nama_jenis_wilayah	=	"Peta Indikatif Arahan Perhutanan Sosial";
			}
			
			layer.bindPopup("<div class='pop-tipe'>"+arr_data.nama_wikera+"</div><div class='row'><div class='col-sm-12' style='margin-top:5px;'>"+nama_jenis_wilayah+"</div></div><div class='row'><div class='col-sm-12'><p align='justify'>"+arr_data.short_narasi+"</p></div></div>")
		}
	}
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="well well-sm" style="margin-top:5px; margin-bottom:-5px;">
						<h6 class="box-title" style="padding-left:5px;ext-transform:uppercase"><strong>PETA SEBARAN KONFLIK & WILAYAH KELOLA</strong></h6>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div id="map-wrapper" style="padding-top:10px;">
						...
						<div id="box-data" class="box-data" style="position:absolute; z-index:1101; top:60px; left:20px; width:300px; height: auto; background:transparent">
							<ul class="nav nav-tabs" id="myTab" style="margin:0; background:transparent; margin-top:-42px">
								...
								<li><a href="#data_tora"><i class="fa fa-globe"></i></a></li>
							</ul>
							...
							<div class="tab-content" id="data_box" style=" background:transparent;margin:0; margin-top:-5px; padding:0px">
										...
										<div class="panel panel-default">
											<div class="panel-heading" style="position:relative; padding-top:10px">
												<p class="panel-title" align="justify">
													Peta Sebaran Konflik & Wilayah Agraria
												</p>
											</div>
										</div>
									...
									<form id="fdata" class="form-horizontal">
										...
										<div id="all-container" class="hiddens">
											...
											<div id="data-container">
												<div id="data-list" style="max-height:130px">
								...
								<div class="tab-pane" id="data_tora">
													...
													<div class="col-sm-12">
														<div class="form-group">
															...
															<div id="check_jenis_wilayah">
																...
																<input type="checkbox" id="check_tora2" />&nbsp;Perhutanan Sosial
															</div>
														</div>
													</div>
												</div>
