	<? $this->load->view($this->public_layout."/footer_js")?>
			...
			<!-- Nested Row Starts -->
				...
				<!-- Foot Col #1 Starts -->
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="foot-info">
							<p>
								<img src="Fin%20Adviser%20-%20Bootstrap%20Template_files/foot-brand.png" alt="Fin Adviser" class="img-responsive img-center-xs">
							</p>
							<br>
							<p class="text-light">
								<em>There are many variations of passages of Lorem Ipsum 
	...
	<!-- Copyright Starts -->
		...
		<!-- Nested Container Starts -->
			<div class="container text-center text-lite-color">
				<em class="text-light">Fine Advisor © 2016. All Rights Reserved. Designed By <a href="#">Sainath Chillapuram</a></em>
			</div>
		<!-- Nested Container Ends -->
		</footer>
	<!-- Copyright Ends	-->
