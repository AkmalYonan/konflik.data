...
<div class="row ">
    <div class="col-sm-12 col-lg-12">
		<div class="col-md-12">
			<h1>View <small>Pegawai</small></h1>
		</div><!-- col -->
				...
				<div class="row topbar box_shadow">
					<div class="col-md-12">
						<div class="rows well well-sm">
							...
							<a class="btn btn-default active" href="<?php echo $this->module?>view/<?=$this->uri->segment(4);?>">
								<i class="fa  fa-table"></i> View
							</a>	 
							<a class="btn btn-default" href="<?php echo $this->module?>view/<?=$this->uri->segment(4);?>">
							...
							<div class="row">
								 <div class="col-md-12">
								  ...
								  <div class="nav-tabs-custom">
									<ul class="nav nav-tabs">
									  <li class=""><a aria-expanded="false" href="#tab_1" data-toggle="tab">Tab 1</a></li>
									  <li class="active"><a aria-expanded="true" href="#tab_2" data-toggle="tab">Tab 2</a></li>
									  <li class="dropdown">
								...
								<div class="">
									...
									<?php
										...
										echo form_open_multipart('admin/pegawai/insert_dokumen', $attributes);
										$data = array(
												  'idx'  => $data['idx'],
												  'nip' => $data['nip']
												);
										...
										?>
									<div class="transparent" style="padding-bottom:0px; margin-top:-9px">
