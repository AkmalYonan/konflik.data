					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a >Verifikasi PUM</a></li>
										...
										<div class="col-md-8" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													...
													<center>
														<span class="label label-warning">Terkirim <i class="fa fa-check"></i></span>
													</center>
													<!--</a>-->
													...
													<div class="modal fade" id="kirim" tabindex="-1" role="dialog">
													  <div class="modal-dialog">
														...
														echo form_open('admin/pegawai/publishx', $attributes);
														$datax = array(
																  'a'  => encrypt($data['idx']),
													...
													<!--<a title="kirim?" onclick="return confirm('Anda yakin kirim data ini ke pusat?');" href="<?php echo site_url("admin/pegawai/publish/".encrypt($data['idx'])."/".encrypt($data['status'])."/".encrypt('a'));?>">																						
													<center>
												...
												<table class="table table-striped">
													...
													<tr>	
														<td><center>
															...
															<a onclick="return confirm('Berkas akan dihapus?');" title="Delete" href="<?= base_url();?>admin/pegawai/delete_berkas_/<?php echo encrypt($row['idx']);?>/<?php echo $row['flag'];?>"><i class="fa fa-trash"></i></a>
															</center>													
														</td>
														<td>
									...
									<div class="row" >
										<div class="col-md-12" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle2"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_kumham'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step2/".encrypt($data['idx'])."/".encrypt($data['stt_kumham']));?>">													
													<center>
									...
									<div class="row" >
										<div class="col-md-6" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle3"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_diklat'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step3/".encrypt($data['idx'])."/".encrypt($data['stt_diklat']));?>">													
													<center>
														<span class="label label-info">Verified <i class="fa fa-check"></i></span>
													</center>
													</a>
									...
									<div class="row" >
										<div class="col-md-6" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle4"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_polri'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step4/".encrypt($data['idx'])."/".encrypt($data['stt_polri']));?>">													
													<center>
														<span class="label label-info">Verified <i class="fa fa-check"></i></span>
													</center>
													</a>
									...
									<div class="row" >
										<div class="col-md-6" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle5"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_kejagung'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step5/".encrypt($data['idx'])."/".encrypt($data['stt_kejagung']));?>">													
													<center>
														<span class="label label-info">Verified <i class="fa fa-check"></i></span>
													</center>
													</a>
									...
									<div class="row" >
										<div class="col-md-6" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle6"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_skep'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publis_step6/".encrypt($data['idx'])."/".encrypt($data['stt_skep']));?>">													
													<center>
														<span class="label label-info">Verified <i class="fa fa-check"></i></span>
													</center>
													</a>
													<?php }elseif($data['stt_skep'] == 0){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step6/".encrypt($data['idx'])."/".encrypt($data['stt_skep']));?>">																						
													<center>
														<span class="label label-danger">Not Verified </span>
													</center>
													<?php } ?>
									...
									<div class="row" >
										<div class="col-md-6" >
											<h4 style="margin-top:10px;border-bottom:0px solid #aaa;font-weight:bold;"> <a class="btn<?=$class_toggle?>" id="filter_toggle7"><i class="fa fa-plus bc-icon"></i> Tambah</a>
												<div style="float:right" >
													<?php if($data['stt_pelantikan'] == 1){?>
													<a title="Verified/Not Verified" href="<?php echo site_url("admin/verifikasi/publish_step7/".encrypt($data['idx'])."/".encrypt($data['stt_pelantikan']));?>">													
													<center>
														<span class="label label-info">Verified <i class="fa fa-check"></i></span>
													</center>
													</a>
