                ...
                <tbody>
                    <?php if(cek_array($arrData)):?>
                            <?php foreach($arrData as $x=>$val):
                                    ...
                                    $entry = $val['creator']."- <br />".$val['edited'];
							...
							?>
								...
								<tr>
                                    ...
                                    <?php $gambar=$val['image']!=''?$val['image']:"noimg.jpg"; ?>
						 	        <td>
                                        <? if($val['image']):?>
                                            <img src="<?=$this->config->item("dir_pp").$gambar?>" id="previewplay" width="50px" style="height:50px; max-height:50px">
                                        <? else:?>
                                           <div style="border:1px solid grey;width:50px !important">
                                                <small><p><center> No <br />Img</center></p></small>
                                           </div>
                                        <? endif;?>
                                    </td>
