	...
	<div class="row">
    	<div class="col-md-12">
            ...
            <ul class="nav nav-tabs nav-justified" id="myTabs" role="tablist"> 
				...
				<li class="active"><a href="<?=$this->module?>">KM dan RD </a></li>
            </ul>
            <!-- :TAB -->
        	<!-- TOOLBAR -->
    ...
    <div class="row">
        <div class="col-md-12" style="position:relative">
            ...
            <div class="box-header with-borders" style="background:rgba(255,255,255,.5); margin-top:-8px">
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="box-title" style="text-transform:uppercase">Dashboard KM & RD</h3>
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-orange">
                                <h3 class="box-title">Komp. Masyarakat</h3>
                                <div class="info-top"><?=$km;?></div>
                            </div>
                            <div class="col-md-3 text-blue">
                                <h3 class="box-title">Rmh Damping</h3>
                                <div class="info-top"><?=$rd?></div>
                            </div>
                            <div class="col-md-3 text-orange">
