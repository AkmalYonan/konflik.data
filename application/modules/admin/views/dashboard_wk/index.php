            ...
            <div class="row">
                <div class="col-md-12" style="position:relative">
                	...
                	<div class="box-header with-borders" style="background:rgba(255,255,255,.6); margin-top:-8px">
                    	<div class="row">
                        	 <div class="col-md-12">
                            	<h3 class="box-title" style="text-transform:uppercase"><strong>DASHBOARD SEBARAN KONFLIK & WILAYAH KELOLA</strong></h3>
...
<div class="row" style="margin-top:2px;">
	...
	<li class="">
		<a style="border-left:none !important;" href="admin/dashboard">
                            ...
                            <div class="col-md-2">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="tora" title="Lihat Sebaran Dampak Konflik">TORA</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
                            ...
                            <div class="col-md-2">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="ps" title="Lihat Sebaran Dampak Konflik">PS</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
                            ...
                            <div class="col-md-2">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="ha" title="Lihat Sebaran Dampak Konflik">HA</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
    	...
    	<div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-8" style="position:relative">
                    ...
                    <div class="box box-widgets" style="background:rgba(255,255,255,.0); border:none;">
                    	<div class="box-header">
                        	<div class="row">
                                <div class="col-md-8">
                                    <h6 class="box-title"><b>SEBARAN LOKASI</b></h6>
                    ...
                    <div class="row">
                    	<div class="col-md-8">
                             <h6 class="box-title" style="text-transform:uppercase"><b>GRAFIK DATA WILAYAH KELOLA PERBULAN</b></h6>
							  <div style="border-top:1px solid #ddd"></div>
							  <br /><br />
                             <div id="jml_per_bulan" style="height:150px" class="hides"></div>
                        </div>
						<div class="col-md-4">
                             <h6 class="box-title" style="text-transform:uppercase"><b>STATUS TAHAPAN</b></h6>
							 <div style="border-top:1px solid #ddd"></div>
                ...
                <div class="col-md-4" style="position:relative; background-color:#ffffff !important">
                      ...
                      <h6 class="box-title" style="text-transform:uppercase;margin-top:10px;margin-bottom:12px"><b>DATA TERBARU</b></h6>
                      <div style="border-top:1px solid #ddd"></div>
                        ...
                        <li class="item" >
                          <div class="row">
                            ...
                            <div class="col-md-9 col-xs-8">
                              <div class="product-info" style="text-align:left !important;margin-left:10px;">
                                <span class="product-title"><strong><?=$v['judul']?></strong></span>
									...
									<span  style="font-size:11px;">
										Luas : <?=($v['luas']?number_format($v['luas']):"0")?> Ha, Tahapan : <?=$tahapan[$v["kode_tahapan"]]?>
                                    </span>
                              </div>
                            </div>
                          </div>
