            	...
            	<div class="box-header with-borders">
                	<div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <? } else { ?>
                              <input id="propinsi" type="hidden" name="kd_prop" value="<?=$kd_prop?>" />
                          <? } ?> 
                          ...
                          <? } else { ?>
                              <input id="kabupaten" type="hidden" name="kd_kab" value="<?=$kd_kab?>" />
                          <? } ?> -->
                          <div class="form-group">
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
									...
									<?php if(!$value['tipe_instansi']): ?>
										<span class="help-block"><?php echo $this->lookup_org[$value["kd_org"]]?></span>
									<?php else: ?>
										<span class="help-block"><?php echo $this->lookup_instansi[$value["kd_org"]]?></span>
									<?php endif; ?>
                                    </td>
                                    <td>
                                    <? if($value["active"]):?>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-xs btn-default" onclick="dF('<?=$id?>','<?php echo $value["username"]?>');"><i class="fa fa-remove red"></i></a>
										</div>
									</td>
                                </tr>
                            <?php endforeach;?>
