<?php
	...
	$arrGroup2JnsOrg=$this->lat_auth->groups('id','jns_org');
?>
                      	...
                      	<div class="col-md-6">
                              ...
                              <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" id="password" name="password" class="form-control" value="<?php echo $data["last_name"];?>" />
...
var group2jnsorg=<?=cek_array($arrGroup2JnsOrg)?json_encode($arrGroup2JnsOrg):'false'?>;
$(document).ready(function(){      
	...
	$("#group_id").change(function(){
		...
		var	uo	=	group2org[tipe];
		//alert(group2jnsorg[tipe]);
		
		$("#kd_org").html('<option>--loading--<option>');
		
		if(uo!=="BNNR"){
			$.get("common/service/lookup_org_by_tipe/"+group2org[tipe],function(ret){
				$("#kd_org").html(ret);
			});
		}else{
			$.get("common/service/lookup_instansi_by_tipe/"+group2jnsorg[tipe],function(ret){
				$("#kd_org").html(ret);
			});
		}
	});
