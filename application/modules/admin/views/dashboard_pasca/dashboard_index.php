    	...
    	<div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12" style="position:relative">
                	...
                	<div class="box-header with-borders" style="background:rgba(255,255,255,.5); margin-top:-8px">
                    	<div class="row">
                        	<div class="col-md-4">
                            	<h3 class="box-title" style="text-transform:uppercase"><strong>DASHBOARD PASCA REHABILITASI</strong></h3>
                                <h5>Pasien yang sedang menjalani Proses Pasca Rehabilitasi<br />
                            ...
                            <div class="col-md-8">
                            	<div class="row">
                                    ...
                                    <div class="col-md-3 text-aqua">
                                    	<h3 class="box-title">PASCA REHAB</h3>
                                        <div class="info-top"><?=$pasca_proses;?></div>
                                    </div>
                                    <div class="col-md-3 text-green">
                                    	<h3 class="box-title">OUTCOME</h3>
                                        <div class="info-top"><?=$pasca_selesai;?></div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8" style="position:relative">
                            <table class="table table-bordered table-condensed small-font" style="margin-bottom:0">
                                <thead>
                                    <tr>
                                      <td colspan="2" align="center" bgcolor="#eeeeee">RAWAT INAP</td>
                                      <td colspan="3" align="center" bgcolor="#eeeeee">RAWAT JALAN</td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="width:20%"><strong>Daily Activity</strong></td>
                                        <td align="center" style="width:20%"><strong>Discharge/Rujukan</strong></td>
                                        <td align="center" style="width:20%"><strong>Peer Group</strong></td>
                                        <td align="center" style="width:20%"><strong>Perkembangan Diri</strong></td>
                                        <td align="center" style="width:20%"><strong>Dukungan Keluarga</strong></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="font-size:40px;">
                                        <td style="color:#ff8c00" align="center"><?=$da?></td>
                                        <td style="color:#268dea" align="center"><?=$dr?></td>
                                        <td style="color:#50b576" align="center"><?=$pg?></td>
                                        <td style="color:#A7CEE5" align="center"><?=$pd?></td>
                                        <td style="color:#fb3e46" align="center"><?=$dk?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <br />
                            <table class="table table-bordered table-condensed small-font" style="margin-bottom:0">
                                <thead>
                                    <tr>
                                      <td colspan="6" align="center" bgcolor="#eeeeee">RAWAT LANJUT</td>
                                    </tr>
                                    <tr>
                                      <td colspan="3" align="center" style="width:50%">PEMANTAUAN</td>
                                      <td colspan="3" align="center" style="width:50%">PENDAMPINGAN</td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="width:16.7%"><strong>Keg. Produktif</strong></td>
                                        <td align="center" style="width:16.7%"><strong>Eval. Perkembangan</strong></td>
                                        <td align="center" style="width:16.7%"><strong>Tes Urin</strong></td>
                                        <td align="center" style="width:16.7%"><strong>Home Visit</strong></td>
                                        <td align="center" style="width:16.7%"><strong>Pert. Kelompok</strong></td>
                                        <td align="center"><strong>Tes Urin</strong></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="font-size:40px;">
                                        <td style="color:#3366cc" align="center"><?=$pukp?></td>
                                        <td style="color:#109618" align="center"><?=$puep?></td>
                                        <td style="color:#109618" align="center"><?=$putu?></td>
                                        <td style="color:#109618" align="center"><?=$pdhv?></td>
                                        <td style="color:#109618" align="center"><?=$pdpk?></td>
                                        <td style="color:#109618" align="center"><?=$pdtu?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <?
							$pp=number_format(($pulih_produktif/$pasca_selesai)*100,2,".",".");
							$ptp=number_format(($pulih_tidak_produktif/$pasca_selesai)*100,2,".",".");
							$tpp=number_format(($tidak_pulih_produktif/$pasca_selesai)*100,2,".",".");
							$tptp=number_format(($tidak_pulih_tidak_produktif/$pasca_selesai)*100,2,".",".");
						?>
                      <div class="col-md-4" style="position:relative; margin-top:-15px">
            ...
            <div class="box box-widget">
            	<div class="box-header with-borders"  style="position:absolutes; z-index:10000">
                	<div class="row">
                        <div class="col-md-8">
                            <h3 class="box-title">PASIEN PASCA REHABILITASI</h3>
                        </div>
                        <div class="col-md-4">
                            <h3 class="box-title">&nbsp;</h3>
                        </div>
