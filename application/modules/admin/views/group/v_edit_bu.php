                              ...
                              <div class="row">
                               		<div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input class="form-control required" id="name" name="name" type="text" value="<?php echo str_replace(" ".$data['use_organization'],"",$data['name']);?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                          <div class="form-group">
                                         <label for="exampleInputEmail1">Tipe Organisasi</label>
                                          <? echo form_dropdown("use_organization",$this->lookup_tipe_org,$data['use_organization'],"id='tipe' class='form-control'");?>                        
                                          </div>
                                    </div>
                                </div>
								
							 <div class="row jns_org hide">
                                <div class="col-md-12">
                                    <div class="form-group">
                                      <label for="exampleInputEmail1">Jenis</label><br />
                                      <input type="radio" name="jns_org" value="BALAI" class="cek_radio" />&nbsp;Balai/Loka
									  <input type="radio" name="jns_org" value="RD" class="cek_radio" />&nbsp;Rumah Damping
									  <input type="radio" name="jns_org" value="KM" class="cek_radio" />&nbsp;Komponen Masyarakat
                                    </div>
                                </div>
                                <!-- /.col -->
                              </div>	
...
$(document).ready(function(){	
	if(jns_org){
		$(".jns_org").removeClass("hide");
	}else{
		$(".jns_org").addClass("hide");
		$(".cek_radio").val("");
	}
