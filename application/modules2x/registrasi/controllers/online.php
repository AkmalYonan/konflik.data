...
class online extends Admin_Controller {
    ...
    function __construct(){
		...
		// lama $this->model_file=new general_model("t_pasien_registrasi_online_file");
		// baru
	...
	function view($id){
		...
		$pasien = $this->model_pasien->GetRecordData("id_pasien_online=$id");
		$idx_pasien = $pasien['idx'];
	 ...
	 function rekam_medis($id){
		...
		if($act=="update"):
			...
			if($status==2): //ok
				...
				$data["id_pasien_online"]=$id; //add baru get dokumen
