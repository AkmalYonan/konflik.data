...
class tolak extends Admin_Controller {
    ...
    function __construct(){
	 ...
	 function listview(){
		...
		$where[]="((status_rehab=1 and status_proses='SS' and status_check_doc=9))";
        $whereSql="";
        if(cek_array($where)):
		...
		$this->_render_page($this->module."v_list_tolak",$data,true);
    }
