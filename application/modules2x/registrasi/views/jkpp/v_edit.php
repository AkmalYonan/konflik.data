						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<?=form_dropdown("kd_konflik[]",$lookup_konflik,$arx,"id='konflik' multiple='multiple'  class='form-control required'");?>
								</div> 
							</div> 
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="pulau_umum" id="pulau_umum" value="<?=$data['pulau_umum']?>">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="investasi" id="investasi" value="<?=str_replace(",",".",number_format($data['investasi']))?>,00">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-group">
										<label>Luas</label>
										<input class="form-control" name="luas" type="text" id="luas" value="<?php echo str_replace(".",",",$data["luas"]);?>" />
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dampak" id="dampak" value="<?php echo str_replace(",",".",number_format($data["dampak"]));?>">
                        ...
                        <div class="row">
                        	<div class="col-md-6">
                            	<div class="form-group">
									...
									<?php echo form_input('longitude',$data["longitude"],'id="x" data-x="'.$data["longitude"].'" class="form-control required"');?>
								</div>
                            </div>
                            <div class="col-md-6">
                            	<div class="form-group">
									<label>Y (Latitude)</label>
									<?php echo form_input('latitude',$data["latitude"],'id="y" data-y="'.$data["latitude"].'" class="form-control required"');?>
									</div>
                            </div>
							<!--
                            <div class="col-md-2">
