    ...
    <div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                	<a class="btn btn-white active" href="<?php echo $this->module?>index_waiting_list" data-toggle='tooltip' data-original-title="List">
                        <i class="fa fa-list"></i>
                    </a>
                    <a class="btn btn-white hidden" href="<?php echo $this->module?>index_pasien_list" data-toggle='tooltip' data-original-title="Add">
                        <i class="fa fa-plus"></i>
                    </a>	  
                    <a class="btn btn-white" href="<?php echo $this->module?>index_waiting_list" data-toggle='tooltip' data-original-title="Refresh">
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
									<?php echo $lookup_status_proses[$val["status_proses"]]?></td>
