                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
							...
							<th>Lama Menunggu</th>
                            <th>Tanggal <br />Rencana Assestmen</th>
                            <th>Tempat Rehabilitasi</th>
                             <!--<th>Status Rehab</th>-->
                             <th>Ketersediaan Ruang</th>
                             <th>AsaL BNNP</th>
                    ...
                    <tbody>
						<?php if(cek_array($arrData)):?>
                            ...
                            ?><tr>
									...
									<?
										$date1 = ($val["tgl_registrasi"])? $val["tgl_registrasi"]:"";
										$date2 = ($val["tgl_assestment"])? $val["tgl_assestment"]:"";
										if($date1 AND $date2):
									...
									?>
                                    <td><?=($val["tgl_registrasi"])? date2indo($val["tgl_registrasi"]):"--"?></td>
                                    <td><?=($selisih)? $selisih." Hari": "0 Hari"?>  </td>
                                    <td><?=($val["tgl_assestment"])? date2indo($val["tgl_assestment"]):"--"?></td>
                                    <td><?=($val["jns_org"]==1)? "BNNP":"";?><?=($val["jns_org"]==2)? "Balai Lokal":"";?> <br />
										<? if($val["jns_org"]==1):?>
										<?=$lookup_bnnp[$val["kd_bnn"]];?>
										<? else:?>
										<?=$lookup_balai[$val["kd_bnn"]];?>
