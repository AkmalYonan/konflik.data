...
<section class="content">
		...
		<div class="col-md-12">
			<? if (message_box()) :?><?php echo message_box();?><? endif; ?>
				<div class="content-toolbar">
						<a class="btn btn-white" href="<?php echo $this->module?>pasien_lama" data-toggle='tooltip' title="Back">
							<i class="fa fa-arrow-left"></i>
						</a>
						<a class="btn btn-white" href="<?php echo $this->module?>reg_lama/<?php echo $id;?>" data-toggle='tooltip' title="Refresh">
	...
	<form id="frm" method="post" action="<?php echo $this->module;?>edit/<?=$id?>">
	<input type="hidden" name="act" id="act" value="update"/>
	<div class="box box-widget" style="padding:10px;">
    	<div class="alert alert-info alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4><i class="icon fa fa-exclamation-circle"></i>Data Pasien Lama</h4>
            Pasien merupakan pasien lama dan tercatat sudah pernah melakukan Rehabilitasi. Proses akan dilanjutkan dengan menggunakan data ini
          </div>
		<div class="row">
			<div class="col-sm-6">
