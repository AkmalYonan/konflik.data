    ...
    <div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                    ...
                    <a class="btn btn-white" href="<?php echo $this->module?>index_pasien_list" data-toggle='tooltip' data-original-title="Refresh">
        	...
        	<div class="box box-widget">
            	<div class="box-header with-borders">
                	<div class="row">
                        ...
                        <form class="form-inline" action="<?=$this->module?>index_pasien_list" method="get">
                                    ...
                                    <td class="hidden" style="text-align:center">
                                     ...
                                     <td align="center">
									 	<div class="btn-group btn-group-xs">
											<a class="btn btn-xs btn-default" href="<?=$this->module?>execute/<?=$id?>" data-toggle='tooltip' title="Pilih Pasien"><i class="fa fa-search blue">&nbsp;</i>Pilih</a> 
										</div>
