...
<section class="content">
	<div class="row">
    	<div class="col-md-12">
			...
			<form id="frm" method="post" action="<?php echo $this->module;?>summary/<?php echo $id;?>" enctype="multipart/form-data">	
						  ...
						  <?=$this->load->view("v_form_assesment")?>
						   ...
						   <h4 class="heading">Konfirmasi</h4>
							<div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row tempat_rujukan hide">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Lampiran Assesment Summary</label>
