	...
	<div class="box box-widget">
            ...
            <div class="tab-content">
              ...
              <h4 class="heading">Registrasi Scan 10 Jari</h4>
                 <?=$this->load->view("registrasi/all_pasien/v_sidik_jari2")?>
                 <?=$this->load->view("registrasi/all_pasien/v_sidik_jari")?>

                 <?=$this->load->view("registrasi/all_pasien/v_sidik_jari_identifikasi")?>
              </div>
