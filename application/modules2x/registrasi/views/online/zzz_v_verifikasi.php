<?php 
	...
	$lookup_status[1]='Belum OK/Masih Proses'; // tetap verifikasi
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                            		<div class="form-group">
                                      ...
                                      <?=form_dropdown("﻿status_check_doc",$lookup_status,$data["﻿status_check_doc"],"id='﻿status_check_doc' class='form-control select2 required'");?>
                                     </div><!-- end form group -->
