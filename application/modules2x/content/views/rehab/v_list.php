...
<?php
	...
	$lookup_category=lookup("cms_pages_category","idx","description");
        	...
        	<div class="box box-widget">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        ...
                        <th class="forder" rel="title">Kategori</th>
                        <!--<td class="tbldata_header forder">Alamat</td>-->
                        <th width="100" class="hidden">Publish</th>
                        <th style="width:70px;" class="hidden">Action</th>
                        </tr>
        		</thead>
                <tbody>
                    <?php if(cek_array($arrData)):?>
							...
							?>
                            	<tr>
                                    ...
                                    <!--<td rel="date_col" width="150"><?=$val['date_formatted'];?></td>-->
                    				<td rel="title_col"><a href="<?=$url_edit;?>"><?=$lookup_category[$val['category']];?></a></td>
                    				<td class="hidden"><?=$status_badges?></td>
