...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Ubah<small> Carausel</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
                ...
                <div class="col-md-12">
                    <div id="imgcontainer">
                        ...
                        <div style="position:relative"> 
							...
							<img src="<?=$this->config->item('dir_slider').$gambar?>" id="previewplay" width="968px" style="height:360px; max-height:360px" class="img-thumbnail">
                            <div style="text-align:left;" class="carousel-caption" style="max-width:600px">
                              <h2 style="text-align:left;" id="s_title"><?=$data['title'];?></h2>
                              <p style="text-align:left;" id="s_lead" class="lead"><?=$data['clip'];?></p>
                              <a style="text-align:left;" id="s_button" class="btn btn-large btn-primary <?=$split[1]?'':'hidden';?>" href="<?=$split[1];?>" target="_blank">...</a>
                            </div>
                        </div>
...
function readURLplay(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#previewplay').attr('width', '968px');
                $('#previewplay').attr('height', '500px');
            }
...
$(document).ready(function () {
	...
	$( "#draggable" ).draggable({ 
		axis: "y",
		stop: function() {
			var p = $('#draggable').parent().offset();
			var o = $('#draggable').offset();
			var n = o.top-p.top;
			if (n>0) {
				//n=0;
				$('#draggable').css("top",0);
	...
	uploader.bind('FilesAdded', function(up, files) {
		...
		$.each(files, function(i,file){
			...
			img.onload = function() {
				...
				$('#canvas_view').css({margin:"2px 10px 10px 2px",width:968,height:500}).addClass("img-polaroid");
				$('#image_data').show();
