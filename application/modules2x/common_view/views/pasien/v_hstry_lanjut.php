	...
	?>
                      ...
                      <div class="row">
                        ...
                        <table class="table table-bordered table-condensed" width='90%'>
							...
							<tbody>
							<?php if(cek_array($pasien_history_lanjut)):?>
								<? foreach($pasien_history_lanjut as $x=>$data):?>
								<tr>
									<td align="center">
									...
									<td align="center">
										<?=($pasien_history_lanjut[$x+1]['status_pasien'])? $status_pasien[$pasien_history_lanjut[$x+1]['status_pasien']]:"<span class='label label-primary'>Proses</label>"?>
									</td>
