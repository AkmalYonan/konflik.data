	...
	?>
					  <div class="row">
                        ...
                        <table class="table table-bordered table-condensed" width='90%'>
							...
							<tbody>
							<?php if(cek_array($pasien_history)):?>
								<? foreach($pasien_history as $x=>$data):?>
								...
								<tr>
									...
									<td align="center">
										<?=($pasien_history[$x+1]['status_pasien'])? $status_pasien[$pasien_history[$x+1]['status_pasien']]:"<span class='label label-primary'>Proses</label>"?>
									</td>
									<!--<td align="center">
