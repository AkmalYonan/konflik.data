...
<div class="row">
	<div class="col-md-12">
        ...
        <h4 class="heading">Pasien
        <div class="pull-right" style="margin-top:-10px;">
        <a href="/print" class="btn btn-sm btn-primary div_id_print_modal" data-div_id="#print_this" data-page_orientation='L' data-page_size='A4' data-toggle='tooltip' data-original-title="Print Preview"><i class="fa fa-print"></i>&nbsp;Print Preview</a></div>
						...
						<table class="table table-condensed">
							...
							<tr>
								...
								<td align="justify" colspan="5"><?=$v['rencana_terapi_resume']?></td>
                                                        ...
                                                        <tr>
                                                            <td><strong>Lampiran Assesment Summary</strong></td>
                                                            <td align="justify">
                                                                <?php if($v['lampiran_assesment']): ?>
                                                                    <a href="<?=$this->config->item("dir_assesment_summary").$v['lampiran_assesment']?>" target="_blank">
                                                                        <span class="label" style="background-color:#8c1aff"><i class="fa fa-download">&nbsp;</i>Unduh Lampiran</span>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
						...
						<?php if($v['inst_rujuk']): ?>
							...
							<table class="table table-condensed">
								...
								<tr>
									...
									<td>
										<?php
											if($v['tgl_dt'] or $v['tgl_dt_selesai']):
												echo "Rawat Inap";
											elseif($v['tgl_kl'] or $v['tgl_kl_selesai']):
												echo "Rawat Jalan";
											endif;
										?>
									</td>
								...
								<?php if($v['tgl_dt'] or $v['tgl_dt_selesai']): ?>
								<tr>
								...
								<?php elseif($v['tgl_kl'] or $v['tgl_kl_selesai']): ?>
								<tr>
							...
							<table class="table table-condensed">
								...
								<tr>
									...
									<?php
										...
										elseif($v['inst_lanjut']):
											if($v['inst_lanjut']=="BNNP"):
												echo $lookup_bnnp[$v['rujuk_lanjut']];
											elseif($v['inst_lanjut']=="BNNK"):
												echo $lookup_bnnk[$v['rujuk_lanjut']];
											else:
												echo $lookup_balai[$v['rujuk_lanjut']];
											endif;
										endif;
									?>
									</td>
