                              ...
                              <div class="row">
                               ...
                               <div class="row">      
									...
									<div class="row" style="margin-bottom:10px">
										<div class="col-md-12">
											<label for="kd_bnn">Pilih Tempat Asal Rujukan</label>
											<br />
									...
									<div class="form-group hidden">
										...
										<!--<input type="text" value="<?=$data_propinsi[substr($data['kd_bnn'],0,2)]?>" name="kd_wilayah_propinsi_txt" class="form-control" id="kd_wilayah_propinsi_txt" readonly="readonly" />-->
										<div class="well well-sm" id="label_propinsi"></div>
                                    </div><!-- end form group -->
                                	</div><!-- end col 6-->
                      		</div><!-- end row-->
                      		<!-- END FIRST FORM-->
<script>
	...
	$(function(){
		...
		$("#label_propinsi").text('<?=$data_propinsi[substr($data['kd_bnn'],0,2)]?>');
		...
		$("#kd_balai").on("change",function(){
			...
			$("#label_propinsi").text(data_propinsi[id_propinsi.substr(0,2)]);
		});
		
		$("#kd_bnn").on("change",function(){
			var data_propinsi=<?=json_encode($data_propinsi)?>||"";
			var kd_propinsi=$(this).find(":selected").val();
			var id_propinsi=kd_propinsi;
