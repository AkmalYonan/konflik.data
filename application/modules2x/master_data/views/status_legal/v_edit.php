                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>edit/<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="kd_kejahatan" type="text" id="kd_kejahatan" value="<?php echo $data["kd_kejahatan"];?>" />
                        </div>
                        <div class="ur_napza">
                          <label for="ur_kejahatan">Jenis Kejahatan</label>
                          <input class="form-control required" name="ur_kejahatan" id="ur_kejahatan" placeholder="" value="<?php echo $data["ur_kejahatan"];?>">
                        </div>
