                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="kd_kejahatan" id="kd_kejahatan" type="text" value="<?php echo $data["kd_kejahatan"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_napza">Jenis Kejahatan</label>
                          <input class="form-control required" name="ur_kejahatan" id="ur_kejahatan" placeholder="" type="text" value="<?php echo $data["ur_kejahatan"];?>">
                        </div>
