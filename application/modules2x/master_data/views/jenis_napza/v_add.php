                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <label for="kd_napza">Kode Napza</label>
                          <input class="form-control required" name="kd_napza" type="text" value="<?php echo $data["kd_napza"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_napza">Nama Napza</label>
                          <input class="form-control required" name="ur_napza" placeholder="" type="text" value="<?php echo $data["ur_napza"];?>">
                        </div>
                         <div class="form-group">
                          <label for="">Penomoran Napza (digunakan di form)</label>
                          <input class="form-control required" name="penomoran" placeholder="" type="text" value="<?php echo $data["penomoran"];?>">
                        </div>
