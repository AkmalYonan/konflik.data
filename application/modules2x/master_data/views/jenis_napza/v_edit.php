                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>edit/<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="kd_napza" type="text" id="kd_napza" value="<?php echo $data["kd_napza"];?>" />
                        </div>
                        <div class="ur_napza">
                          <label for="exampleInputEmail1">Nama</label>
                          <input class="form-control required" name="ur_napza" id="ur_napza" placeholder="" value="<?php echo $data["ur_napza"];?>">
                        </div>
                        
                        <div class="form-group">
                          <label for="penomoran">Penomoran Napza (digunakan di form)</label>
