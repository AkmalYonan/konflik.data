                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="kd_jenis_instansi" type="text" value="<?php echo $data["kd_jenis_instansi"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_jenis_instansi">Jenis Instansi</label>
                          <input class="form-control required" name="ur_jenis_instansi" placeholder="" type="text" value="<?php echo $data["ur_jenis_instansi"];?>">
                        </div>
