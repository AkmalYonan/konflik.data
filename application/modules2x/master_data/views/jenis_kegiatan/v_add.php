    	...
    	<div class="col-md-12">
        	...
        	<div class="box box-default">
                <div class="box-header with-border clearfix">
                    ...
                    <a class="btn btn-white" href="<?php echo $this->module?>add/<?=$kategori?>" data-toggle='tooltip' title="Refresh">
                        <i class="fa fa-refresh"></i>
                    </a>
                    <a class="btn btn-white btn-save" href="" data-toggle='tooltip' title="Save">
                        <i class="fa fa-check"></i>
                    </a>
                    <a class="btn btn-white" href="<?php echo $this->module?>index/<?=$kategori?>" data-toggle='tooltip' title="Reset">
                        <i class="fa fa-circle-o"></i>
                    </a>	  
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                <form id="frm" method="post" action="<?php echo $this->module;?>add/<?=$kategori?>">
                  <input type="hidden" name="act" id="act" value="create"/>
				  <input type="hidden" name="kategori" value="<?=$kategori?>" />
                  <div class="row">
                    <div class="col-md-6">
                      	<div class="form-group">
                          <label for="kd_napza">Kode</label>
                          <input class="form-control required" name="kd_jenis_kegiatan" id="kd_jenis_kegiatan" type="text" value="<?php echo $data["kd_jenis_kegiatan"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_napza">Jenis Kegiatan</label>
                          <input class="form-control required" name="ur_jenis_kegiatan" id="ur_jenis_kegiatan" placeholder="" type="text" value="<?php echo $data["ur_jenis_kegiatan"];?>">
                        </div>
