...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo $this->module?>"><?=$this->module_title?></a></li>
  </ol>
</section>
    ...
    <div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                	<a class="btn btn-white active" href="<?php echo $this->module?>index/<?=$kategori?>" data-toggle='tooltip' data-original-title="List">
                        <i class="fa fa-list"></i>
                    </a>
                    <a class="btn btn-white" href="<?php echo $this->module?>add/<?=$kategori?>" data-toggle='tooltip' data-original-title="Add">
                        <i class="fa fa-plus"></i>
                    </a>	  
                    <a class="btn btn-white" href="<?php echo $this->module?>index/<?=$kategori?>" data-toggle='tooltip' data-original-title="Refresh">
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $value["kd_jenis_kegiatan"]?></td>
                                    <td><?php echo $value["ur_jenis_kegiatan"]?></td>
                                    
                                     <td style="text-align:center">
										<?php if($value["order_num"]>1):?>
                                            <a href="<?=$this->module?>up/<?=$kategori?>/<?=$id?>">
											<i class="fa fa-arrow-up" data-toggle='tooltip' title="up"></i>
											</a>
                                        <? endif;?>
                                    </td>
                                    <td style="text-align:center">
										<?php if($value["order_num"]< count($arrData)):?>
                                            <a href="<?=$this->module?>down/<?=$kategori?>/<?=$id?>" data-toggle='tooltip' title="down"><i class="fa fa-arrow-down"></i></a>
                                        <? endif;?>
                                    ...
                                    <td align="center">
                                        <a class="btn btn-xs btn-success" href="<?=$this->module?>edit/<?=$kategori?>/<?=$id?>" data-toggle='tooltip' title="Edit"><i class="fa fa-pencil"></i></a> 
                                        <a class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?');" data-toggle='tooltip' href="<?php echo $this->module."del/".$kategori."/".$id?>" title="Delete"><i class="fa fa-remove"></i></a> 
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
