...
?>
<?php
	$lookup_tipe_tempat[""]="--Pilih--";
	$lookup_tipe_tempat=$lookup_tipe_tempat+lookup("m_jenis_tempat_rehab","kd_jenis","ur_jenis","","order by order_num");
                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>edit/<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="nama_tempat" type="text" id="nama_tempat" value="<?php echo $data["nama_tempat"];?>" />
                        </div>
                        <div class="form-group">
                        	<label for="ur_jenis_instansi">Alamat</label>
                          <input class="form-control required" name="alamat" id="alamat" placeholder="" value="<?php echo $data["alamat"];?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="category">Organisasi di atasnya</label>
                            
                                <? echo form_dropdown("tipe_tempat",$lookup_tipe_tempat,$data["tipe_tempat"],"id='tipe_tempat' class='form-control select2'");?>
