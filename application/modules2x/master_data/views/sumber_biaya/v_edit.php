                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>edit/<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <label for="kd_sumber">Kode</label>
                          <input class="form-control required" name="kd_sumber" type="text" id="kd_sumber" value="<?php echo $data["kd_sumber"];?>" />
                        </div>
                        <div class="ur_napza">
                          <label for="ur_jenis_instansi">Jenis Instansi</label>
                          <input class="form-control required" name="ur_sumber" id="ur_sumber" placeholder="" value="<?php echo $data["ur_sumber"];?>">
                        </div>
