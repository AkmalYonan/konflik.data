                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <input class="form-control required" name="kd_sumber" type="text" value="<?php echo $data["kd_sumber"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_jenis_instansi">Sumber Biaya</label>
                          <input class="form-control required" name="ur_sumber" placeholder="" type="text" value="<?php echo $data["ur_sumber"];?>">
                        </div>
