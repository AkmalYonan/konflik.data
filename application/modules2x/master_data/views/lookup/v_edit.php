<?php 
	...
	$lookup_category_empty[""]="--Pilih--";
	$lookup_category=$lookup_category_empty+lookup("m_lookup_category","kd_lookup_category","ur_lookup_category","","order by order_num");
                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>edit/<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                           ...
                           <? echo form_dropdown("lookup_category",$lookup_category,$data["lookup_category"],"id='lookup_category' class='form-control select2'");?>
                        </div><!-- /control-group category-->
                        
                        <div class="form-group">
                          <label for="kd_napza">Kode Lookup</label>
                          <input class="form-control required" name="kd_lookup" type="text" value="<?php echo $data["kd_lookup"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_napza">Nama Lookup</label>
                          <input class="form-control required" name="ur_lookup" placeholder="" type="text" value="<?php echo $data["ur_lookup"];?>">
                        </div>
