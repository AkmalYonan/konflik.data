	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="box box-widget">
                ...
                <div class="box-body">
                <form id="frm" method="post" action="<?php echo $this->module;?>edit_category/<?php echo $id;?>">
                  <input type="hidden" name="act" id="act" value="update"/>
                  <input type="hidden" name="id" id="id" value="<?php echo $id;?>"/>
                  <div class="row">
                    <div class="col-md-6">
                      	 <div class="form-group">
                          <label for="kd_napza">Kode Kategori</label>
                          <input class="form-control required" name="kd_lookup_category" type="text" value="<?php echo $data["kd_lookup_category"];?>" />
                        </div>
                        <div class="form-group">
                          <label for="ur_napza">Uraian</label>
                          <input class="form-control required" name="ur_lookup_category" placeholder="" type="text" value="<?php echo $data["ur_lookup_category"];?>">
                        </div>
