									...
									<td>
										<?php
											if($act=="add"):
												...
												echo form_dropdown("kd_org",$lookup_balai,$data['kd_org'],"id='kd_balai' class='form-control select2 required' disabled='disabled' style='width:30%'");
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#home">Fasilitas Ruang</a></li>
