...
<script src="https://maps.google.com/maps/api/js?v=3.2&sensor=false&key=AIzaSyA7XHSKsB-cg9tG1XWbBEf1CKa1uIGYmw4"></script>
...
<script>
	...
	function loadMap(){
		...
		var url="<?=$this->base_url?>data_service/map/ipwl.geojson?limit=-1&x_gte=95&y_gte=-11&y_lte=11";
		$("#loader_leaflet").show();
