    	...
    	<div class="col-md-12">
        	...
        	<div class="box box-default">
                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="jenis_tempat_rehab" id="jenis_tempat_rehab" value="IPWL"/>
                  <div class="row">
                    <div class="col-md-6">
                    	<div class="form-group">
                                <label for="category">Kepemilikan</label>
                                	<? echo form_dropdown("kepemilikan",$lookup_kepemilikan,$data["kepemilikan"],"id='kepemilikan' class='form-control select2'");?>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php $path	=	$this->config->item("dir_instansi"); ?>
