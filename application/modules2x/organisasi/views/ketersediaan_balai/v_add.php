                ...
                <form id="frm" method="post" action="<?php echo $this->module;?>add">
                          ...
                          <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <label style="padding-right:10px">
                              	 <input type="checkbox" name="rawat_inap" class="flat-red" <?php echo $data['rawat_inap']?"checked='checked'":'';?> value="I"> Rawat Inap
                              </label>
                              <label style="padding-right:10px">
                              	<input type="checkbox" name="rawat_jalan" class="flat-red" <?php echo $data['rawat_jalan']?"checked='checked'":'';?> value="J"> Rawat Jalan
                             </label>	
                              <label>
                              	<input type="checkbox" name="rawat_pasca" class="flat-red" <?php echo $data['rawat_pasca']?"checked='checked'":'';?> value="1">Pasca
                             </label>	
						...
						<div class="row">
							<div class="col-md-6">
								...
								<label>Kapasitas Daya Tampung</label>
									<input type="text" class="form-control" id="kapasitas" disabled="disabled" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
                    	...
                    	<div class="row">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<? echo form_dropdown("kd_bnn",false,false,"id='bnnp' class='form-control' readonly='readonly'");?> 
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									...
									<label>Masa Berlaku</label>
										<div class="input-group">
											...
											<input type="text" id="masa_berlaku_selector" class="form-control input-date required" value="<?=date("d/m/Y")?>" placeholder="dd/mm/yyyy"/>
											<input type="hidden" id="masa_berlaku" name="masa_berlaku" value="<?=date("Y-m-d")?>" class="required" />
										</div>
									</div>
								</div>
								<div class="col-md-6">
									...
									<label>KMK</label>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" id="kmk_selector" class="form-control input-date required" value="<?=date("d/m/Y")?>" placeholder="dd/mm/yyyy"/>
											<input type="hidden" id="kmk_berlaku" name="kmk" value="<?=date("Y-m-d")?>" class="required" />
										</div>
									</div>
								</div>
							</div>
				  ...
				  <div class="row">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<img id="attachment1" src="<?=$path?>pic.jpg" width="200" height="200" style="border:thin solid #CCCCCC" />
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<label>TMT Jabatan</label>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" id="tmt_jabatan_selector" class="form-control input-date required" value="<?=date("d/m/Y")?>" placeholder="dd/mm/yyyy"/>
											<input type="hidden" id="tmt_jabatan" name="tmt_jabatan" value="<?=date("Y-m-d")?>" class="required" />
										</div>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-6">
						...
						<div class="row">
							<div class="col-sm-6">
								<img id="attachment2" src="<?=$path?>noimg.jpg" width="275" height="150" style="border:thin solid #CCCCCC" />
								<input type="file" name="fasilitas1" id="imgInp2" />
								<input type="hidden" name="foto2" id="foto2" />
							</div>
							
							<div class="col-sm-6">
								<img id="attachment3" src="<?=$path?>noimg.jpg" width="275" height="150" style="border:thin solid #CCCCCC" />
