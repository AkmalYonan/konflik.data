    ...
    <div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                    ...
                    <a class="btn btn-white" href="<?php echo $this->module?>index_bnnk" data-toggle='tooltip' data-original-title="Add">
                        <i class="fa fa-plus"></i>
                    </a>	  
                    <a class="btn btn-white" href="<?php echo $this->module?>index_bnnk" data-toggle='tooltip' data-original-title="Refresh">
        	...
        	<div class="box box-widget">
            	<div class="box-header with-borders">
                	<div class="row">
                        ...
                        <form class="form-inline" action="<?=$this->module?>index_bnnk" method="get">
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $value["tipe_org"]?></td>
                                    
                                    
                                     <td align="center">
                                        <a class="btn btn-xs btn-success" href="<?=$this->module?>edit_bnnk/<?=$id?>" data-toggle='tooltip' title="Edit"><i class="fa fa-pencil"></i></a> 
                                        <a class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?');" data-toggle='tooltip' href="<?php echo $this->module."del_bnnk/".$id?>" title="Delete"><i class="fa fa-remove"></i></a> 
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
