						...
						<?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $val["nama"];?><br /><span class="text-muted"><em><?php echo $this->data_lookup["jenis_kelamin"][$val["jenis_kelamin"]];?></em>&nbsp;</span>
                                        <!--
                                        <//?php if($val['flag_notification']==1): ?>
                                        <small style="color:#0000ff">(Pasien Baru Rehabilitasi)</small>
                                        <//?php endif; ?>
                                        -->
                                    </td>
