                	...
                	<div class="row">
						<div class="col-sm-6">
									<ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#homex" aria-controls="homex" role="tab" data-toggle="tab">Data Primary Treatment</a></li>
										<!--
										<li role="presentation"><a href="#page2" aria-controls="page2" role="tab" data-toggle="tab">Data Kegiatan Primary Treatment</a></li>
										-->
                                    </ul>
								    
									<div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Kegiatan Primary Treatment  <a class="pull-right btn btn-xs btn-primary add_clean" data-toggle='tooltip' title="Tambah Data Primary Treatment"><i class="fa fa-plus"></i></a></h4>
											<?=$this->load->view("v_form_primary");?>
										</div>
										
										<!--
										<div role="tabpanel" class="tab-pane" id="page2">
											<h4 class="heading">Daftar Kegiatan Primary Treatment</h4>
											<div class="box-body table-responsive">
												...
												<table class="table table-bordered table-condensed small-font">
													...
													<tbody>	
														<?php if(cek_array($pasien_pt_history)):?>
						...
						<div class="col-sm-6">
									...
									<ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" ><a href="#asm" aria-controls="asm" role="tab" data-toggle="tab">Data Assessment</a></li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="asm">
											...
											<h4 class="heading">Data Assessment</h4>
...
<script>
	$(document).ready(function(){
		$(".edit_data").on("click",function(){
			$(".title_form").text("Edit Data Primary Treatment");
				
			var string = $(this).data("ref");
			eval('var object='+string);
				
			<?php foreach($pasien_pt_history[0] as $k=>$v): ?>
			...
			if(lampiran){
				var href	=	'<a href="<?=$this->config->item("dir_pt")?>'+lampiran+'" target="_blank">Unduh Lampiran</a>';
		...
		$(".add_clean").on("click",function(){
			$(".title_form").text("Tambah Data Primary Treatment");
