                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            ...
                            <th>Jenis Kelamin</th>
                            <th>Tgl Input</th>
                            <th colspan="2">Lama Detoxifikasi</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $val["nama"];?>
                                        <!--
                                        <//?php if($val['flag_notification']==1): ?>
                                        <br />
                                        <small style="color:#0000ff">(Pasien Baru Rawat Inap)</small>
                                        <//?php endif; ?>
                                        -->
                                    </td>
                                    ...
                                    <td width="80" align="right"><?php echo $val["lama_detox"]?></td>
									<td width="40" align="right">Hari</td>
