...
<div class="content-toolbar">
	<div class="row">
		<div class="col-md-9 ">
			<form class="form-inline" action="<?=$this->module?>index_outcome" method="get">
				...
				<div class="row">
					<div class="col-sm-12" style="margin-bottom:10px">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a href="<?=$this->module?>index_outcome">Outcome Rehabilitasi</a></li>
						</ul>
					</div>
				</div><!--End Of Row-->
					...
					<div id="div_excel">
						...
						<table align="center">
							<tr>
								...
								<td>
									<p style="text-align:center;font-size:12pt;font-weight:bold;letter-spacing:1px;">OUTCOME PASIEN</p>
						...
						<table class="table table-bordered table-condensed" width="100%">
							<thead>
								<tr>
									...
									<th width="30%"><p align="center">Nama</p></th>
									...
									<td align="center">
										<?php
											switch($data['status_pasien']):
												...
												case "KB":
													echo "<span class='label label-warning'>Kambuh</span>";
												break;
...
<div id="div_excel2" class="hidden">
                		...
                		<? $flag_yes="1";
							$flag_no="0";
						?>
						<p><b><center>OUTCOME PASIEN<br><?=$organization;?><br>TAHUN <?=$tahun?></center></b></p>
