<?php
	...
	$lookup_pertemuan[5]="5";
	$lookup_pertemuan[6]="6";
	$lookup_pertemuan[7]="7";
	$lookup_pertemuan[8]="8";
											...
											<div class="box-body table-responsive">
												<table class="table table-striped table-condensed data_tbl">
													<tbody>		
														...
														<?php if(count($model_kl_history)>0):?>
															<?php foreach($model_kl_history as $x=>$val):
															...
															?>
																<tr id="tr_<?=$val['idx']?>">
																	...
																	<td> Petugas : <?php echo $val["petugas"]?></td>
																	<td align="center">
																		<?php 
																			switch($val["hasil_tes"]):
																				case 1: 
																	...
																	<td align="center">
																		<?php if($val['lampiran']): ?>
																			<a href="<?=$this->config->item("dir_kl").$val['lampiran']?>" target="_blank">
																	 ...
																	 <td align="center">
																		...
																		<a class="btn btn-xs btn-default edit_data" data-ref="{<?=$data_ref?>}" data-toggle='tooltip' title="Edit"><i class="fa fa-pencil green"></i></a> 
...
<h4 class="heading title_form">Tambah Data Kegiatan Konseling  </h4>
...
<form id="frm" method="post" enctype="multipart/form-data" action="<?php echo $this->module;?>update_proses/<?php echo $id;?>">
    ...
    <div class="col-md-12">
    	...
    	<div class="form-group">
							...
							<textarea class="input-xs form-control" id="kegiatan" rows="4" name="kegiatan" placeholder=""></textarea>
        </div>
		<div class="form-group">
        					<label for="alamat">No. Telpon PJ/Keluarga</label>
							 <input class="form-control required" name="tlp_kel" id="tlp_kel" type="text" />
        </div>
		<div class="form-group">
        					<label for="alamat">Nama PJ/Keluarga</label>
							 <input class="form-control required" name="nama_kel" id="nama_kel" type="text" />
        </div>
		<div class="form-group">
        					<label for="alamat">Alamat</label>
							<textarea class="input-xs form-control" id="alamat" rows="4" name="alamat" placeholder=""></textarea>
        </div>
		<div class="form-group">
			<label id="hasil_tes_label">Hasil</label>
			<table cellspacing="5" cellpadding="5">
				<tbody><tr>
					<td align="center"><input id="radio_plus" name="hasil_tes" value="1" type="radio"></td>
					<td width="50"><strong> Positif</strong></td>
					<td>[ <span class="label label-success"><i class="fa fa-plus"></i></span> ]</td>
					<td width="25">&nbsp;</td>
					<td align="center"><input id="radio_minus" name="hasil_tes" value="2" type="radio"></td>
					<td width="50"><strong> Negatif</strong></td>
					<td>[ <span class="label label-danger"><i class="fa fa-minus"></i></span> ]</td>
					<td></td>
				</tr>
		...
		<div class="form-group">
        					<label for="alamat">Nama Petugas Evaluasi</label>
							 <input class="form-control required" name="petugas" id="petugas" type="text"  />
        </div>
