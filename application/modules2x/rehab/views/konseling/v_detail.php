                	...
                	<div class="row">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" role="tablist">
                            	<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Data Konseling</a></li>
                                ...
                                <!--<li role="presentation"><a href="#tes" aria-controls="tes" role="tab" data-toggle="tab">Test Komeng</a></li>-->
                            </ul>

                            <!-- Tab panes -->
                            <div class="tab-content">
                            	<div role="tabpanel" class="tab-pane active" id="home" style=" backgorund-color:grey">
									<h4 class="heading">Konseling</h4>
									<?=$this->load->view("v_detail_konseling");?>
								</div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="tes" style=" backgorund-color:grey">
									<h4 class="heading">Pasien</h4>
									<?=$this->load->view("common_view/pasien/v_data_pasien_rh2");?>
								</div>
							</div>							
						</div>
						...
						<div class="col-sm-6">
							...
							<div class="tab-content">
                            	<div role="tabpanel" class="tab-pane active" id="homex">
									<h4 class="heading">Data Konseling</h4>
									<?//=$this->load->view("v_detail_konseling");?>
								</div>
                            </div>
						</div>
