...
<form id="frm" method="post" enctype="multipart/form-data" action="<?php echo $this->module;?>update_proses/<?php echo $id;?>">
    ...
    <div class="col-md-12">
    	...
    	<div class="form-group">
							...
							<textarea class="input-xs form-control" id="kegiatan" rows="4" name="kegiatan" placeholder=""><?=$data_proses["kegiatan"]?></textarea>
        </div>
		<div class="form-group">
        					<label for="alamat">No. Telpon PJ/Keluarga</label>
							 <input class="form-control required" name="tlp_kel" id="tlp_kel" type="text" value="<?php echo $data_proses["tlp_kel"];?>" />
        </div>
		<div class="form-group">
        					<label for="alamat">Nama PJ/Keluarga</label>
							 <input class="form-control required" name="nama_kel" id="nama_kel" type="text" value="<?php echo $data_proses["nama_kel"];?>" />
        </div>
		<div class="form-group">
        					<label for="alamat">Alamat</label>
							<textarea class="input-xs form-control" id="alamat" rows="4" name="alamat" placeholder=""><?=$data_proses["alamat"]?></textarea>
        </div>
		<div class="form-group">
			<label id="hasil_tes_label">Hasil</label>
			<table cellspacing="5" cellpadding="5">
				<tbody><tr>
					<td align="center"><input id="radio_plus" name="hasil_tes" <?=($data_proses["hasil_tes"]==1)?'checked':''?> value="1" type="radio"></td>
					<td width="50"><strong> Positif</strong></td>
					<td>[ <span class="label label-success"><i class="fa fa-plus"></i></span> ]</td>
					<td width="25">&nbsp;</td>
					<td align="center"><input id="radio_minus" name="hasil_tes" <?=($data_proses["hasil_tes"]==2)?'checked':''?> value="2" type="radio"></td>
		...
		<div class="form-group">
        					<label for="alamat">Nama Petugas Evaluasi</label>
							 <input class="form-control required" name="petugas" id="petugas" type="text" value="<?php echo $data_proses["petugas"];?>" />
        </div>
		...
		<div class="form-group">
					...
					<?php if($data_proses["lampiran"]){?>
						File: <a target="_blank" href="<?=$this->config->item("dir_kl").$data_proses["lampiran"]?>">Download</a>
					<?php } ?>
				</div><!-- end form-->
