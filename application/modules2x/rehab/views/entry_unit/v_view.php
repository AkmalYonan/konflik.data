                	...
                	<div class="row">
						<div class="col-sm-6">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<!--
										<li role="presentation"><a href="#page2" aria-controls="page2" role="tab" data-toggle="tab">Data Kegiatan Entry Unit</a></li>
										-->
                                    </ul>
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Kegiatan Entry Unit <a class="pull-right btn btn-xs btn-primary add_clean" data-toggle='tooltip' title="Tambah Data Detox"><i class="fa fa-plus"></i></a></h4>
											<?=$this->load->view("v_form_entry_unit");?>
										</div>
										
										<!--
										<div role="tabpanel" class="tab-pane" id="page2">
											<h4 class="heading">Daftar Kegiatan Entry Unit</h4>
											<div class="box-body table-responsive">
												<table class="table table-bordered table-condensed small-font">
													...
													<tbody>	
														<?php if(cek_array($pasien_eu_history)):?>
															<?php foreach($pasien_eu_history as $x=>$val):
															...
															?>
																<tr>
																	...
																	<td><?php echo $val["jenis_kegiatan"]?></td>
																	 ...
																	 <td align="center">
																		<?php if($val['lampiran']): ?>
																			<a href="<?=$this->config->item("dir_eu").$val['lampiran']?>" target="_blank">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-3 tgl_selesai_program">
									<?php
										$tgl_limit_prev = $monitoring_rehab['tgl_dt_selesai'];
...
<script>
	$(document).ready(function(){
		$(".edit_data").on("click",function(){
			$(".title_form").text("Edit Data Entry Unit");
				
			var string = $(this).data("ref");
			eval('var object='+string);
			
			<?php foreach($pasien_eu_history[0] as $k=>$v): ?>
		...
		$(".add_clean").on("click",function(){
			$(".title_form").text("Tambah Data Entry Unit");
