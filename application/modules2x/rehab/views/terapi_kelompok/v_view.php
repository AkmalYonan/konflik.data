                	...
                	<div class="row">
						<div class="col-sm-6">
									<ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#homex" aria-controls="homex" role="tab" data-toggle="tab">Data Terapi Kelompok</a></li>
                                    </ul>
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Kegiatan Terapi Kelompok  <a class="pull-right btn btn-xs btn-primary add_clean" data-toggle='tooltip' title="Tambah Data Terapi Kelompok"><i class="fa fa-plus"></i></a></h4>
											<?=$this->load->view("v_form_terapi_kelompok");?>
										</div>
                                    </div>
						</div>
						<div class="col-sm-6">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3 tgl_selesai_program">
										<?php
											$tgl_limit_prev = $monitoring_rehab['tgl_kl_selesai'];
...
<script>
	$(document).ready(function(){
		$(".edit_data").on("click",function(){
			$(".title_form").text("Edit Data Kegiatan Terapi Kelompok ");
				
			var string = $(this).data("ref");
			eval('var object='+string);
			
			<?php foreach($pasien_tk_history[0] as $k=>$v): ?>
		...
		$(".add_clean").on("click",function(){
			$(".title_form").text("Tambah Data Kegiatan Terapi Kelompok");
