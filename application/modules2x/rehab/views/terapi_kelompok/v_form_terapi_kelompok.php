...
?>
		...
		<div class="box-body table-responsive">
			<table class="table table-striped table-condensed data_tbl">
				<tbody>	
					<?php if(count($pasien_tk_history)>0):?>
						<?php foreach($pasien_tk_history as $x=>$val):
...
<h4 class="heading title_form">Tambah Kegiatan Terapi Kelompok </h4>
    ...
    <div class="col-md-12">
		...
		<div class="form-group">
					...
					<?php if($data_proses["lampiran"]){?>
						File: <a target="_blank" href="<?=$this->config->item("dir_tk").$data_proses["lampiran"]?>">Download</a>
					<?php } ?>
				</div><!-- end form-->
