                	...
                	<div class="row">
						<div class="col-sm-6">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation"><a href="#page2" aria-controls="page2" role="tab" data-toggle="tab">Data Kegiatan Konseling</a></li>
                                    </ul>
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Konseling  <a class="hidden pull-right btn btn-xs btn-primary btn-add" href="javascript:void()" data-toggle='tooltip' title="Add Entry Unit"><i class="fa fa-plus"></i> Tambah Data Entry Unit</a></h4>
											<?=$this->load->view("v_form_konseling_edit");?>
										</div>
										
										<div role="tabpanel" class="tab-pane" id="page2">
											<h4 class="heading">Daftar Kegiatan Konseling</h4>
											<div class="box-body table-responsive">
												...
												<table class="table table-bordered table-condensed small-font">
													<thead>
														<tr>
															<th width="20px">No.</th>
															<th width="100px"><center>Tgl Kegiatan</center></th>
															<th width="100px"><center>Pertemuan Ke-</center></th>
													...
													<tbody>	
														<?php if(cek_array($model_kl_history)):?>
