						...
						<div class="col-sm-6">
								    ...
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Terapi Kelompok  <a class="hidden pull-right btn btn-xs btn-primary btn-add" href="javascript:void()" data-toggle='tooltip' title="Add Entry Unit"><i class="fa fa-plus"></i> Tambah Data Entry Unit</a></h4>
											<?=$this->load->view("v_form_terapi_kelompok_edit");?>
										</div>
                                    </div>
						</div>
						<div class="col-sm-6">
