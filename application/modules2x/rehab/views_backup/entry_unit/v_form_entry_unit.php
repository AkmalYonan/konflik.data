...
<div class="row">
	<div class="col-sm-12">
		<table class="table table-striped table-condensed data_tbl">	
			<?php if(count($pasien_eu_history)>0):?>
				...
				<tr id="tr_<?=$val['idx']?>">
					...
					<td align="center"><?php echo $val["pertemuan_ke"]?></td>
...
<div class="row">
	<div class="col-sm-12">
		<h4 class="heading title_form">Tambah Data Entry Unit</h4>
	</div>
</div>
			...
			<div class="row">
				<div class="col-md-6">
                	<label for="jenis_pendidikan">Pertemuan Ke</label>
                    	<?=form_dropdown("pertemuan_ke",$lookup_pertemuan,"","id='pertemuan_ke' class='form-control required'");?>
				</div>
			</div>
		</div><!-- end form group-->
		<div class="form-group">
