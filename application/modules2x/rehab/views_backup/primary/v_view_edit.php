						...
						<div class="col-sm-6">
								    ...
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Primary Treatment  <a class="hidden pull-right btn btn-xs btn-primary btn-add" href="javascript:void()" data-toggle='tooltip' title="Add Detox"><i class="fa fa-plus"></i> Tambah Data Detox</a></h4>
											<?=$this->load->view("v_form_primary_edit");?>
										</div>
