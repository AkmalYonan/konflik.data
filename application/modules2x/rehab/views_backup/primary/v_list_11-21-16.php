    	...
    	<div class="col-md-12">
        	...
        	<div class="box box-widget">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            <th  class="tmiddle" width="20" rowspan="2">No.</th>
                            <th rowspan="2" class="tmiddle">Nama</th>
                            <th rowspan="2" class="tmiddle">No Rekam Medis</th>
                            <th rowspan="2" class="tmiddle">Jenis Kelamin</th>
                            <th rowspan="2" class="tmiddle">Tgl Input</th>
                            <th colspan="2" class="tmiddle">Primary Treatment Yang diikuti</th>
                            <th rowspan="2" class="tmiddle">Tanggal Mulai</th>
                            <th rowspan="2" class="tmiddle">Tanggal Selesai</th>
                            <th rowspan="2" class="tmiddle">Kegiatan</th>
							<th rowspan="2" class="tmiddle">Status</th>
							<th rowspan="2" class="tmiddle">Lampiran</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $this->data_lookup["jenis_kelamin"][$val["jenis_kelamin"]];?></td>
                                     <td><?php echo date2indo($val["tgl_kegiatan"])?></td>
                                     <td><?php echo $val["jenis_kegiatan"]=="pt1"?"4 Bulan":"-";?></td>
                                     <td><?php echo $val["jenis_kegiatan"]=="pt2"?"6 Bulan":"-";?></td>
                                     <td><?php echo date2indo($val["tgl_mulai"])?></td>
                                     <td><?php echo date2indo($val["tgl_selesai"])?></td>                                    
                                     ...
                                     <td align="center">
                                        ...
                                        <a class="btn btn-xs btn-default" href="<?=$this->module?>view/<?=$id?>" data-toggle='tooltip' title="Edit"><i class="fa fa-search green"></i></a> 
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach;?>
