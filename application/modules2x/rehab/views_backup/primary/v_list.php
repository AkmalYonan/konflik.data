    	...
    	<div class="col-md-12">
        	...
        	<div class="box box-widget">
                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            <th  class="tmiddle" width="20" >No.</th>
                            <th  class="tmiddle">Nama</th>
							<th>Tempat Rehab</th>
                            <th  class="tmiddle">No Rekam Medis</th>
                            <th  class="tmiddle">Jenis Kelamin</th>
                            <th  class="tmiddle">Tgl Input</th>
                            <th  class="tmiddle">Kegiatan (Termasuk Tahap Perubahan Klien)</th>
							<th  class="tmiddle">Status</th>
							<th  class="tmiddle">Lampiran</th>
                                    ...
                                    <td><?php echo $this->data_lookup["jenis_kelamin"][$val["jenis_kelamin"]];?></td>
                                     ...
                                     <td align="center">
                                     	<div class="btn-group btn-group-xs">
											<a class="btn btn-xs btn-default" href="<?=$this->module?>detail/<?=$id?>" data-toggle='tooltip' title="View"><i class="fa fa-search blue"></i></a> 
