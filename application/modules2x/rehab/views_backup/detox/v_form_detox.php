...
?>	
	...
	<div class="row">
		<div class="col-sm-12">
			<table class="table table-striped table-condensed small-font data_tbl">
				<?php if(count($pasien_detox_history)>0):?>
						...
						<td align="center">
							...
							<?php 
								foreach($val as $k=>$v): 
									$ref[]	=	$k.":'".$v."'";
								endforeach;
								$ref[]	=	"tgl_mulai:'".date("Y-m-d",strtotime($val["tgl_kegiatan"]))."'";
								$ref[]	=	"tgl_mulai_selector:'".date("d/m/Y",strtotime($val["tgl_kegiatan"]))."'";
								$data_ref	=	join(',',$ref);
							?>
                    ...
                    <? //$tgl_limit_prev = $val['tgl_kegiatan'] ?>
					<?php endforeach;?>
				<?php else: ?>
					<tr>
	...
	<div class="row">
		<div class="col-sm-12">
			<h4 class="heading title_form">Tambah Data Detox</h4>
		</div>
	</div>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						<input type="text" id="tgl_mulai_selector" class="input-sm form-control input-date required" value="<?=date("d/m/Y",strtotime($tgl_mulai))?>" placeholder="dd/mm/yyyy" data-mindate="<?=date("d/m/Y",strtotime($tgl_limit_prev))?>" />
				...
				<div class="col-md-6">
					...
					<div class="input-group">
						<input class="form-control required" name="lama_detox" id="lama_detox" type="text">
    	...
    	<div class="form-group">
			<div class="row">
				<div class="col-md-12">
					...
					<textarea class="input-xs form-control" id="keterangan" rows="3" name="keterangan" placeholder=""></textarea>
				</div>
			</div>
		</div>
