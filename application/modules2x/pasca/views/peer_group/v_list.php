                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
							...
							<!--
							<th>Pertemuan Ke Dua</th>
							<th>Pertemuan Ke Tiga</th>
							<th>Pertemuan Ke Empat</th>
							-->
                    ...
                    <tbody>
                        <?php if(cek_array($arrData)):?>
							...
							<?php
								...
								// if($val['tgl_pertemuan_3']):
									// $pertemuan3	=	date_format(date_create($val['tgl_pertemuan_3']),"d-m-Y");
								// else:
									// $pertemuan3	=	"-";
								// endif;
								
								// if($val['tgl_pertemuan_4']):
									// $pertemuan4	=	date_format(date_create($val['tgl_pertemuan_4']),"d-m-Y");
								// else:
									// $pertemuan4	=	"-";
								// endif;
							?>
							<!--End-->
                                <tr>
									...
									<td align="right"><?php echo ($val['idx_pertemuan'])?$val['idx_pertemuan']:"<center>-</center>"?></td>
									<td align="center"><?php echo $pertemuan; ?></td>
									<!--
									<td align="center"><?php //echo $pertemuan2; ?></td>
									<td align="center"><?php //echo $pertemuan3; ?></td>
									<td align="center"><?php //echo $pertemuan4; ?></td>
									-->
                                    <td><?php foreach($jenis_kegiatan as $k=>$v): ?>
										<?php if($v['idx']==$val['idx_jenis_kegiatan']){
											echo $v['ur_jenis_kegiatan'];
										}?>
										<?php endforeach; ?>
									</td>
