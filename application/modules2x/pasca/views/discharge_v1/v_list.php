                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead valign="top">
                        <tr>
                            ...
                            <th rowspan="2">Jumlah Aggota<br />Kelompok Hadir</th>
							<th colspan="2" >Pertemuan Ke 1</th>
                            <th colspan="2">Pertemuan Ke 2</th>
                            <th rowspan="2">Keterangan Pertemuan <br /> Kelompok</th>
						...
						<?php if(cek_array($arrData)):?>
							...
							?>
                                <tr>
									...
									<td><?php echo date2indo($val["tgl_p1"])?></td>
                                    <td align="center"><?=($val["hasilp1"]==1)? "<span style='color:green;font-size:20px;'><b>+</b></span>" : "<span style='color:red;font-size:20px;'><b>-</b></span>"?></td>
									<td><?php echo date2indo($val["tgl_p2"])?></td>
                                    <td align="center"><?=($val["hasilp2"]==1)? "<span style='color:green;font-size:20px;'><b>+</b></span>" : "<span style='color:red;font-size:20px;'><b>-</b></span>"?></td>
									...
									<td><?php echo $val["nm_petugas"]?></td>
                                     ...
                                     <td align="center">
                                        ...
                                        <!--href="<?=$this->module?>view_detail/<?=$id?>"
										<a class="btn btn-xs btn-default" data-toggle='tooltip' title="Detail"><i class="fa fa-search blue"></i></a> -->
