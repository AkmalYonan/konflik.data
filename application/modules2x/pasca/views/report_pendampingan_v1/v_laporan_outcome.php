...
?>
					<div id="div_excel">
						<table align="center">
							<tr>
								...
								<td>
									<p style="text-align:center;font-size:12pt;font-weight:bold;letter-spacing:1px;">OUTCOME PASIEN PASCA REHABILITASI</p>
                ...
                <div id="div_excel2" class="hidden">
                		<? 
							...
							$flag_no=0;
						?>
						<p><b><center>OUTCOME PASIEN PASCA REHABILITASI<br><?=$organization;?><br>TAHUN <?=$tahun?></center></b></p>
