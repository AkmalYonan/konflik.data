            ...
            <div class="box-body">
				...
				<div id="print_this" class="bg-white">
							...
							<?php if(cek_array($arrData)):?>
								...
								<tr>
									...
									<td align="center">
										<!--
										<?//php
											if($data['jns_org']=="2" || $data['jns_org']=="4" || $data['jns_org']=="5"):
					...
					<div id="div_excel" class="hidden">
						<p><b><center>RUJUKAN PASIEN PASCA REHABILITASI<br><?=$organization;?><br>TAHUN <?=$tahun?></center></b></p>
						<table class="table table-bordered table-condensed">
							<thead>
								<tr>
									<th width="25"><p align="center">No</p></th>
...
<script>
	$(function(){
		...
		$("a.print-excel").click(function(e){
			...
			var file="laporan_pasien_rujukan_<?="_".date("YmdHis").".xls";?>";
