						...
						<?php if(cek_array($arrData)):?>
							...
							?>
                                <tr>
                                    ...
                                    <td><?php echo ($val["tgl_rujukan"])?date2indo($val["tgl_rujukan"]):"<center>-</center>"?></td>
                                    
									<td><?php echo $this->data_lookup["jenis_discharge"][$val['jns_rujukan']]?></td>
									
									<td><?php echo $val["keterangan"]?></td>
									<td align="center">
                                     <?php if($val["lampiran"]){?>
                                     		
                                            <a target="_blank" class="primary" href="<?=$this->config->item("dir_discharge").$val["lampiran"]?>"><span class="label label-info"><i class="fa fa-download">&nbsp;</i>Unduh Lampiran</span></a>	
