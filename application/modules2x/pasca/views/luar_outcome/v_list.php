                    ...
                    <tbody>
						<?php if(cek_array($arrData)):?>
                            <?php foreach($arrData as $x=>$val):
									$id=$this->encrypt_status==TRUE?encrypt($val["idx"]):$val["idx"];	
							...
							?>
                                <tr>
									...
									<td align="right" width="50"><?php echo $val["umur"];?></td>
									...
									<td align="center">
										<?php
											if($val['status_program']=='DO'):
												echo "<span class='label label-primary'>Drop Out</span>";
											elseif($val['status_program']=='KB'):
												echo "<span class='label label-warning'>Kambuh</span>";
											elseif($val['status_program']=='MD'):
												echo "<span class='label label-danger'>Meninggal Dunia</span>";
											endif;		
										?>
									</td>
									<td align="center">
