                        ...
                        <?php if(cek_array($arrData)):?>
							...
							<!--End-->
                                <tr>
									...
									<td align="center">
										<?php if($val['file']): ?>
											<a href="<?=$this->config->item("dir_pemantauan_urin").$val['file']?>" target="_blank">
                                    ...
                                    <td align="center">
                                    	<div class="btn-group btn-group-xs">
											...
											<a class="btn btn-xs btn-default" href="<?=$this->module?>view/<?=$id?>/<?=encrypt('PEMANTAUAN')?>" data-toggle='tooltip' title="Edit"><i class="fa fa-pencil green"></i></a>  
