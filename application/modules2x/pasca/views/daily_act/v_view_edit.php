                	...
                	<div class="row">
						<div class="col-sm-6">
									<ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#homex" aria-controls="homex" role="tab" data-toggle="tab">Data Daily Activity</a></li>
                                    </ul>
								    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="homex">
											<h4 class="heading">Data Daily Activity <a class="hidden pull-right btn btn-xs btn-primary btn-add" href="javascript:void()" data-toggle='tooltip' title="Add Entry Unit"><i class="fa fa-plus"></i> Tambah Data Entry Unit</a></h4>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="profile">
										  ...
										  <div role="tabpanel" class="tab-pane" id="messages">
											<h4 class="heading">History Pasca Rehab</h4>
											<?=$this->load->view("common_view/pasien/v_hstry_pasca");?>
											<h4 class="heading">Monitoring Pasca Rehab</h4>
