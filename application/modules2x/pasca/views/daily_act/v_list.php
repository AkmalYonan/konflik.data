						...
						<?php if(cek_array($arrData)):?>
							...
							?>
                                <tr>
									...
									<td><?=$lookup_jns_org[$val['inst_pasca']]?><br />
										<?=$lookup_inst[$val["rujuk_pasca"]]?>
										
									</td>
                                    <td><?php echo $val["no_rekam_medis"];?></td>
                                    <td><?php echo $this->data_lookup["jenis_kelamin"][$val["jenis_kelamin"]];?></td>
                                    <td><?php echo ($val["tgl_mulai"])?date2indo($val["tgl_mulai"]):"<center>-</center>"?></td>
                                    <td><?php echo ($val["tgl_selesai"])?date2indo($val["tgl_selesai"]):"<center>-</center>"?></td>
                                    
									 <td><?=$this->lookjns_kgt[$val["jenis_kegiatan"]];?></td>
									 <td><?php echo $val["keterangan"]?></td>
									 <td align="center">
									 <?php if($val["lampiran"]): ?>
									 	<a href="<?=$this->config->item("dir_da").$val['lampiran']?>" target="_blank">
									 		<button class="btn btn-xs btn-warning"><i class="fa fa-download">&nbsp;</i>Unduh Lampiran</button>
										</a>
									 <?php endif; ?>
									 </td>
