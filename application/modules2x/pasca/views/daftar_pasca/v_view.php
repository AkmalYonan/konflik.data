						...
						<div class="col-sm-12">
							<ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Rehabilitasi</a></li>
																<li role="presentation" class=""><a href="#dokumen" aria-controls="dokumen" role="tab" data-toggle="tab">File Pendukung</a></li>
                            ...
                            <div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="dokumen" style=" backgorund-color:grey">
		<!--<h4 class="heading">Pasien</h4>-->
