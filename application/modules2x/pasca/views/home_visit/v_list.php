                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead valign="top">
                        <tr>
							...
							<th colspan="2" >Home Visit Ke 1</th>
                            <th colspan="2">Home Visit Ke 2</th>
							<th colspan="2" >Home Visit Ke 3</th>
                            <th colspan="2">Home Visit Ke 4</th>
						...
						<?php if(cek_array($arrData)):?>
							...
							?>
                                <tr>
									...
									<?php for($i=1; $i<5; $i++): ?>
									<td><?php if($val['hv'.$i]["tgl_hm"]): echo date2indo($val['hv'.$i]["tgl_hm"]); else: echo "<center>-</center>"; endif; ?></td>
                                    <? if($val['hv'.$i]["hsl_hm"]):?>
									<td align="center"><?=($val['hv'.$i]["hsl_hm"]==1)? "<span class='label label-success'><i class='fa fa-plus'></i></span>" : "<span class='label label-danger'><i class='fa fa-minus'></i></span>"?></td>
									<? else:?>
									<td align="center">-</td>
									<? endif;?>
									<?php endfor; ?>
									...
									?>
									<td align="center"><?=($hsl_evl==1)? "<span class='label label-success'><i class='fa fa-plus'></i></span>" : "<span class='label label-danger'><i class='fa fa-minus'></i></span>"?></td>
