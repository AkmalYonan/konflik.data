		...
		<div class="box box-widget">
            ...
            <div class="box-body">
				...
				<div class="row">
					<div class="col-sm-12" style="margin-bottom:10px">
						<ul class="nav nav-tabs">
							...
							<li><a href="<?=$this->module?>index_rawat_lanjut">Rujukan Pasien</a></li>
							<li><a href="<?=$this->module?>index_outcome">Outcome Pasca Rehabilitasi</a></li>
							<li class="active"><a href="<?=$this->module?>index_status">Status Pasien Rawat Lanjut</a></li>
						</ul>
					</div>
				</div><!--End Of Row-->
				...
				<div id="print_this" class="bg-white">
					<br>
					<div id="div_excel">
						<h4>Laporan Status Pasien Rawat Lanjut</h4>
						<table class="table table-bordered table-condensed">
							<thead>
								<tr>
									...
									<th><p align="center">Bulan Ke 1</p></th>
									<th><p align="center">Bulan Ke 2</p></th>
									<th><p align="center">Bulan Ke 3</p></th>
									<th><p align="center">Bulan Ke 4</p></th>
