			...
			<div class="box box-widget">				
                <div class="box-body table-responsive">
                	<div class="row">
						...
						<div class="col-sm-6">
							<h4 class="heading">Data Pasca Rehab <a class="hidden pull-right btn btn-xs btn-primary btn-add" href="javascript:void()" data-toggle='tooltip' title="Add Entry Unit"><i class="fa fa-plus"></i> Tambah Data Entry Unit</a></h4>
