	   ...
	   <h4 class="heading">Disclaimer</h4>
		<div class="row">
			<div class="col-md-6">
				...
				$lookup_berikut["PRAP"]		=	"Assesment Pra Program";
				$lookup_berikut["PRRIDA"]	=	"Rawat Inap - Daily Activity";
				$lookup_berikut["PRRJPG"]	=	"Rawat Jalan - Peer Group";
				$lookup_berikut["PRRLPUKP"]	=	"Rawat Lanjut - Pemantauan - Kegiatan Produktif";
				$lookup_berikut["PRRLPDHV"]	=	"Rawat Lanjut - Pendampingan - Home Visit";
				
				$lookup_proses_berikut=$lookup_berikut;
				...
				<div class="form-group status_proses">
					...
					<?=form_dropdown("status_proses",$lookup_proses_berikut,$data["inst_pasca"],"id='status_proses'class='form-control select2 required'");?>
				</div><!-- end form-->
