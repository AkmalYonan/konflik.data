...
<section class="content-header">
  <h1 class="hidden-xs">
    ...
    <small>Pasien Kegiatan Produktif</small>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
        	...
        	<div class="box box-default">
				...
				<div class="row">
					...
					<ul class="nav nav-tabs" role="tablist">
                         <li role="presentation" class="active"><a href="#homex" aria-controls="homex" role="tab" data-toggle="tab">Data Kegiatan Produktif</a></li>
                    </ul>
						<div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="homex">
						<h4 class="heading">Data Kegiatan Produktif</h4>
	...
	<input type="hidden" name="outcome_pasien_sebelumnya" id="outcome_pasien_sebelumnya" value="<?php echo $data["outcome_pasien"];?>"/>
							...
							<?php
								if($datax['tgl_awal']):
									$awal_selector		=	date_format(date_create($datax['tgl_awal']),"d-m-Y");
									$awal				=	date_format(date_create($datax['tgl_awal']),"Y-m-d");
								else:
									$awal_selector	=	date("d-m-Y");
									$awal			=	date("Y-m-d");
								endif;
									...
									<div class="form-group">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
												<input type="text" id="tgl_kegiatan_selector" class="form-control input-date required" value="<?=$kegiatan_selector?>" placeholder="dd/mm/yyyy" data-mindate="<?=date("d/m/Y",strtotime($tgl_limit_prev))?>" />
							...
							<div class="form-group">
								...
								<input type="text" name="no_tlp_pj_keluarga" class="form-control" value="<?=$datax['no_tlp_pj_keluarga']?>" />
							</div>
							
							<div class="form-group">
								<label>Alamat PJ/Keluarga</label>
								<textarea name="alamat_pj_keluarga" class="form-control" rows="3"><?=$datax['alamat_pj_keluarga']?></textarea>
							</div>
							...
							<div class="form-group">
									...
									File: <a target="_blank" href="<?=$this->config->item("dir_produktif").$datax["lampiran"]?>">Download</a>
								<?php } ?>
							</div>
							...
							<div class="form-group status_prosesx">
								<div class="row">
									<div class="col-md-6">
									<label for="namax">Proses Berikutnya?</label><br>
