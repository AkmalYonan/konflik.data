                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            ...
                            <th>Jenis Kelamin</th>
							<th>No Telepon</th>
                            <!--<th>Tanggal Awal Pemantauan</th>-->
							<th>Tanggal Kegiatan</th>
							<th>Kegiatan <br />Produktif</th>
							<th>Nama <br />PJ Keluarga</th>
                            <th>Hasil <br />Pemantauan</th>                            
                            <th>Nama <br />Petugas Pemantau</th>
                    ...
                    <tbody>
                        <?php if(cek_array($arrData)):?>
							...
							<?php
								if($val['tgl_awal']):
									$awal	=	date_format(date_create($val['tgl_awal']),"d-m-Y");
								else:
									$awal	=	"-";
								endif;
								
								if($val['tgl_kegiatan']):
									$kegiatan	=	date_format(date_create($val['tgl_kegiatan']),"d-m-Y");
								else:
									$kegiatan	=	"-";
								endif;
							?>
							<!--End-->
                                <tr>
									...
									<td align="center"><?php echo $val["no_tlp_pj_keluarga"];?></td>
									<!--<td align="center"><?//php echo $awal; ?></td>-->
									<td align="center"><?php echo $kegiatan; ?></td>
									<td><?php echo $val['ur_jenis_kegiatan']; ?></td>
									<td><?php echo $val['nama_pj_keluarga']; ?></td>
									<td align="center">
