<?php 
	...
	$tgl_limit_prev = $monitoring_pasca['tgl_pd_selesai']; 
?>
        	...
        	<div class="box box-default">
				...
				<div class="row">
					...
					<ul class="nav nav-tabs" role="tablist">
                         <li role="presentation" class="active"><a href="#homex" aria-controls="homex" role="tab" data-toggle="tab">Data Kegiatan Dukungan Keluarga</a></li>
                    </ul>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										<input type="text" id="tgl_registrasi_selector" class="form-control input-date required" value="<?=$tanggal_selector?>" placeholder="dd/mm/yyyy" style="width:35%" data-mindate="<?=date("d/m/Y",strtotime($tgl_limit_prev))?>" />
