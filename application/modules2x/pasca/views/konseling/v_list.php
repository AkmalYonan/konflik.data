                ...
                <table class="table table-bordered table-condensed small-font">
                    <thead>
                        <tr>
                            ...
                            <th>Nama PJ/Keluarga</th>
							<th>No. Telp PJ/Keluarga</th>
							<th>Nama Petugas</th>
							<th>Lampiran</th>
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo ($val["tgl_konseling"])?date2indo($val["tgl_konseling"]):""?></td>
									<td align="center">
										<?php if($val["hasil_konseling"]==1): ?>
											<span class="label label-success"><i class="fa fa-plus"></i></span>
										<?php elseif($val["hasil_konseling"]==2): ?>
											<span class="label label-danger"><i class="fa fa-minus"></i></span>
										<?php endif; ?>
									</td>
                                    <td><?php echo $val["nama_pj_keluarga"]; ?></td>
									<td><?php echo $val["no_telp_pj_keluarga"]; ?></td>
                                    <td><?php echo $val["nama_petugas"]?></td>
									<td align="center">
									 	<?php if($val['lampiran']): ?>
											<a href="<?=$this->config->item("dir_pasca_konseling").$val['lampiran']?>" target="_blank">
