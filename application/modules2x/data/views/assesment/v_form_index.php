	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="box box-widget">
                ...
                <div class="box-body">
                <form id="frm" method="post" action="<?php echo $this->module;?>form/<?php echo $id;?>">
                  ...
                  <div class="row">
                  	<div class="col-md-12">
                    	<h4 class="heading">Informasi Pasien/Residen</h4>
                    </div>
                  </div>
                  <div class="row">
                  	<div class="col-md-6">
                        	...
                        	<?php
                            	$tgl_kedatangan=$data["tgl_kedatangan"]?$data["tgl_kedatangan"]:date("Y-m-d H:i:s");
							?>
                        	<label for="nama">Tgl Kedatangan</label>
                        	<div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                  <input type="text" id="tgl_registrasi_selector" class="input-sm form-control input-date required" value="<?=date("d/m/Y",strtotime($tgl_kedatangan))?>" placeholder="dd/mm/yyyy"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                        	<div class="form-group">
                                    <label for="golongan_darah">Status Perkawinan</label>
                  ...
                  <!-- /.row -->
                   <?=$this->load->view("v_medis")?>
                  
                  <div class="formSep"></div>
                  <?=$this->load->view("v_dukungan_hidup")?>
                  
                  <div class="formSep"></div>
                  <?=$this->load->view("v_keluarga_sosial")?>
                  
                  
                  <div class="formSep"></div>
                  <?=$this->load->view("v_narkotika")?>
                  
                  <div class="formSep"></div>
                  <?=$this->load->view("v_legal")?>
                  
                   <div class="formSep"></div>
                  <?=$this->load->view("v_pemeriksaan_fisik")?>
