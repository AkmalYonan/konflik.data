    ...
    <div class="row">
    	<div class="col-md-12">
        	...
        	<div class="content-toolbar">
                	<a class="btn btn-white active" href="<?php echo $this->module?>list_instansi" data-toggle='tooltip' data-original-title="List">
                        <i class="fa fa-list"></i>
                    </a>
                    <a class="btn btn-white" href="<?php echo $this->module?>add" data-toggle='tooltip' data-original-title="Add">
                        <i class="fa fa-plus"></i>
                    </a>	  
                    <a class="btn btn-white" href="<?php echo $this->module?>list_instansi" data-toggle='tooltip' data-original-title="Refresh">
                        <i class="fa fa-refresh"></i>
                    </a>
                    <a class="pull-right btn btn-white hidden" href="<?php echo $this->module?>peta" data-toggle='tooltip' data-original-title="Peta">
        	...
        	<div class="box box-widget">
            	<div class="box-header with-borders">
                	<div class="row">
                        ...
                        <form class="form-inline" action="<?=$this->module?>list_instansi" method="get">
                    ...
                    <tbody>
                        <?php if(cek_array($arrData)):?>
                            <?php foreach($arrData as $x=>$value):
                                    $kode_org=$this->encrypt_status==TRUE?encrypt($value['kd_org']):$value['kd_org'];
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
										 <a class="btn btn-xs btn-info" href="<?=$this->module?>view/<?=$kode_org?>" data-toggle='tooltip' title="View"><i class="fa fa-search"></i></a> 
                                        <a class="btn btn-xs btn-success" href="<?=$this->module?>edit/<?=$kode_org?>" data-toggle='tooltip' title="Edit"><i class="fa fa-pencil"></i></a> 
                                        <a class="btn btn-xs btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?');" data-toggle='tooltip' href="<?php echo $this->module."del/".$kode_org?>" title="Delete"><i class="fa fa-remove"></i></a> 
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
