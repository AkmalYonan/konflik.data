    		...
    		<div class="box box-widget">
                ...
                <div class="box-body">
                		...
                		<form id="frm" method="post" action="<?php echo $this->module;?>verifikasi/<?=$id?>">
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                            		<div class="form-group">
                                      ...
                                      <div class="form-group">
									<?php
                                        $tgl_konfirmasi=$data["tgl_konfirmasi"]?$data["tgl_konfirmasi"]:date("Y-m-d H:i:s");
                                    ?>
                                   <label for="nama">Tanggal Konfirmasi Ke Pasien</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                          <input type="text" id="tgl_konfirmasi_selector" class="form-control input-date required" value="<?=date("d/m/Y",strtotime($tgl_konfirmasi))?>" placeholder="dd/mm/yyyy"/>
                                          <input type="hidden" id="tgl_konfirmasi" name="tgl_konfirmasi" value="<?=date("Y-m-d",strtotime($tgl_konfirmasi));?>" class="required" />
                                    </div>
                                ...
                                <div class="form-group">
                                        <label for="alamat">Catatan Konfirmasi</label>
                                        <textarea class="input-xs form-control" id="catatan_konfirmasi" rows="5" name="catatan_konfirmasi" placeholder=""><?=$data["catatan_konfirmasi"]?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <?php
                                        $jadwal_rekam_medis=$data["jadwal_rekam_medis"]?$data["jadwal_rekam_medis"]:date("Y-m-d H:i:s");
                                    ?>
                                    <label for="nama">Rencana Tanggal Rekam Medis</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                          <input type="text" id="jadwal_rekam_medis_selector" class="form-control input-date required" value="<?=date("d/m/Y",strtotime($jadwal_rekam_medis))?>" placeholder="dd/mm/yyyy"/>
                                          <input type="hidden" id="jadwal_rekam_medis" name="jadwal_rekam_medis" value="<?=date("Y-m-d",strtotime($jadwal_rekam_medis));?>" class="required" />
                                    </div>
                            ...
                            <input type="checkbox" name="flag_konfirmasi" value="1" <?=$data["flag_konfirmasi"]==1?"checked='checked'":""?> id="flag_konfirmasi" /> Apakah pasien sudah dihubungi, berkenaan dengan jadwal interview?
