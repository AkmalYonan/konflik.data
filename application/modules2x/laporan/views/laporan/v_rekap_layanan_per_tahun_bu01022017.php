...
<table align="center">
	<tr>
        ...
        <td>
            ...
            <p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">JUMLAH LAYANAN REHABILITASI <br>S/D TAHUN <?=$tahun?>
            </p>
...
<div class="row">
    <h4 style="margin-left:10px;">Keterangan</h4>
    <div class="col-sm-6">
        <table class="table">
            <thead>
                <tr>
