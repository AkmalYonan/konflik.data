...
if($tipe_instansi_user):
	...
	if($tipe_instansi_user=="BNNP" or $tipe_instansi_user=="BNNK"):
		$arr_alamat=lookup("m_org","kd_org","alamat","(tipe_org='BNNP' or tipe_org='BNNK') and kd_org='".$kd_org."' and active=1","order by kd_wilayah");
		$arr_instansi=lookup("m_org","kd_org","nama","(tipe_org='BNNP' or tipe_org='BNNK') and kd_org='".$kd_org."' and active=1","order by kd_wilayah");
		$nama_instansi	=	$arr_instansi[$kd_org];
		$alamat	=	$arr_alamat[$kd_org];
	elseif($tipe_instansi_user=="BL" or $tipe_instansi_user=="BB"):
		$arr_alamat=lookup("m_instansi","kd_instansi","alamat","(jenis_tempat_rehab='BB' or jenis_tempat_rehab='BLK') and kd_instansi='".$kd_org."' and active=1","order by id_kabupaten");
		$arr_instansi=lookup("m_instansi","kd_instansi","nama","(jenis_tempat_rehab='BB' or jenis_tempat_rehab='BLK') and kd_instansi='".$kd_org."' and active=1","order by id_kabupaten");
		$nama_instansi	=	$arr_instansi[$kd_org];
		$alamat	=	$arr_alamat[$kd_org];
	endif;
	...
	if($tipe_instansi=="BNNP" or $tipe_instansi=="BNNK"):
		$arr_alamat=lookup("m_org","kd_org","alamat","(tipe_org='BNNP' or tipe_org='BNNK') and kd_org='".$req['kd_org']."' and active=1","order by kd_wilayah");
		$alamat	=	$arr_alamat[$req['kd_org']];
	elseif($tipe_instansi=="BL" or $tipe_instansi=="BB"):
		$arr_alamat=lookup("m_instansi","kd_instansi","alamat","(jenis_tempat_rehab='BB' or jenis_tempat_rehab='BLK') and kd_instansi='".$req['kd_org']."' and active=1","order by id_kabupaten");
		$alamat	=	$arr_alamat[$req['kd_org']];
	endif;
...
<div class="content-toolbar">
					<div class="row">
                        <div class="col-md-8">
                            <form action="<?=$this->module?>rekap_tahunan" method="get">
...
<table align="center">
	<tr>
        ...
        <td>
        	<p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">REKAPITULASI LAPORAN TAHUNAN </p>
            <p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">JUMLAH LAYANAN REHABILITASI <?=($tipe_instansi_user)?$nama_instansi:""?><br>S/D TAHUN <?=$tahun?>
            </p>
...
<table class="table table-bordered" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="tr"><?php echo $data["selesai"];?></td>
            <td class="tr"><?php echo $data["do"];?></td>
            <td class="tr"><?php echo $data["md"];?></td>
            <td class="tr"><?php echo $data["kb"];?></td>
...
<table class="table">
	<tr>
		<td colspan="4"><h4>Keterangan</h4></td>
	</tr>
	<tr>
		<td>
			<table class="table">
