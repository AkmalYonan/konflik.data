...
<table align="center">
	<tr>
        ...
        <td>
        	<p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">LAPORAN MONITORING PASIEN </p>
			<?php if(!$tipe_instansi_user): ?>
...
<table class="table table-bordered" style="width:100%">
    ...
    <th rowspan="3" style="vertical-align:top;text-align:center" width="150">PASIEN</th>
