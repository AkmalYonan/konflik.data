...
<table align="center">
	<tr>
        ...
        <td>
            ...
            <p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">JUMLAH LAYANAN REHABILITASI <?=($tipe_instansi_user)?$nama_instansi:""?><br>BULAN <?=strtoupper($bln[$bulan]);?> TAHUN <?=$tahun?>
            </p>
