...
<div class="content-toolbar">
		<div class="row">
		<div class="col-sm-8">
			<form action="<?=$this->module?>rekap_status_rawat" method="get">
...
<div id="div_excel">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<h4 align="center">STATUS RAWAT</h4>
		</div>
	</div>
			...
			<table class="table table-bordered table-condensed">
				<thead>
					<tr>
						...
						<th rowspan="2"><p align="center">PERAWATAN</p></th>
						<th rowspan="2"><p align="center">TARGET</p></th>
						<th colspan="12"><p align="center">REALISASI</p></th>
				...
				<?php if(cek_array($arrData)):?>
					...
					<tr>
						<td align="center" rowspan="3" valign="middle"><?=($x+1)?></td>
						<td rowspan="3" valign="middle"><?=$v['namaProvinsi']?></td>
						<td>INAP</td>
						<td align="right"></td>
						<?php foreach($listMonth as $ki=>$vi): ?>
						<td align="right"><?=$v['inap_'.($ki+1)]?></td>
						<?php endforeach; ?>
						<td align="right"><strong><?=$v['total_inap']?></strong></td>
					</tr>
					<tr>
						<td>JALAN</td>
						<td align="right"></td>
						<?php foreach($listMonth as $ki=>$vi): ?>
						<td align="right"><?=$v['jalan_'.($ki+1)]?></td>
						<?php endforeach; ?>
						<td align="right"><strong><?=$v['total_jalan']?></strong></td>
					</tr>
					<tr>
						<td>PASCA</td>
						<td align="right"></td>
						<?php foreach($listMonth as $ki=>$vi): ?>
						<td align="right"><?=$v['pasca_'.($ki+1)]?></td>
						<?php endforeach; ?>
						<td align="right"><strong><?=$v['total_pasca']?></strong></td>
					</tr>		
					<?php endforeach;?>
					<tr>
						<td>&nbsp;</td>
