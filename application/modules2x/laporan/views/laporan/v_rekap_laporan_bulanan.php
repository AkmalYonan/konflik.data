...
<table align="center">
	<tr>
        ...
        <td>
            ...
            <p style="text-align:center;font-size:14pt;font-weight:bold;letter-spacing:1px;">NAMA KLINIK PRATAMA BNN/BNNP/BNNK <br/>
            BALAI/LOKA REHABILITASI BNN
            </p>
            <p style="text-align:center;font-size:12pt;font-weight:bold;">Alamat Klinik Pratama :</p>
		</td>
    </tr>
</table>
<style>
...
<table class="table table-bordered table-condensed">
    ...
    <tr>
    	...
    	<th colspan="2" style="vertical-align:top;">Jumlah Client</th>
        <th colspan="21" style="vertical-align:top;">Diagnosa dan Jumlah Bentuk Layanan</th>
        <th colspan="4" style="vertical-align:top;">Jumlah Rujukan</th>
    </tr>
    <tr>
    ...
    <tbody>
        ...
        <?
			//replace F18_F19 to f18_f19
        	$data[strtolower(str_replace(",","_",$data["diagnosis_napza"]))]=1;
			$data["baru"]=$data["flag_pasien"]==0?1:"";
			$data["lama"]=$data["flag_pasien"]==1?1:"";
    	...
    	<tr>
            ...
            <td><?php echo $data["f18_f19"];?></td>
            <td><?php echo $data["diagnosis_lain"];?></td>
            <td><?php echo $data["rencana_terapi"];?></td>
