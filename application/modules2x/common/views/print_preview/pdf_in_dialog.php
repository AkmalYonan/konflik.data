...
<div class="row  no_print" >
	<div class="col-md-12">
    	<div class="pull-right">
        	<div class="btn-group">
            	<a href="<?=$this->module?><?=$data["print_url"]?>/<?=$id_mst?>" class="btn btn-default btn-xs">Print HTML</a>
...
<input type="text" id="id_mst" name="id_mst" value="<?=$id_mst?>" />
...
<script>
    ...
    var iframTarget= $('#frm_target'); // changed the code to use jQuery
