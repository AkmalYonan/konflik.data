<?php 
	...
	$lookup_bnnp2=lookup("m_org","kd_wilayah","nama","tipe_org='BNNP'","order by idx");
	...
	<div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Identitas</b> <span class="pull-right"><?=$data["jenis_identitas"]?>, <?=$data["no_identitas"]?></span>
                </li>
                <li class="list-group-item">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
			  ...
			  <hr>
			  <strong><i class="fa fa-map-marker margin-r-5"></i><?=($data['jns_org']==2)?"BALAI/LOKA":"BNNP"?></strong> <br />
				<? if($data['jns_org']==2){ ?>
					<?=$lookup_balai[$data['kd_bnn']]?>
				<? }else{?>
					<?=$lookup_bnnp2[$data['kd_bnn']]?>
				<? }?>
			  <hr>
