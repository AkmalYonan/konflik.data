		...
		<div class="col-md-12">
			<? if (message_box()) :?><?php echo message_box();?><? endif; ?>
				<div class="content-toolbar">
						<a class="btn btn-white" href="<?php echo $this->module?>add" data-toggle='tooltip' title="Back">
							<i class="fa fa-arrow-left"></i>
						</a>
						<a class="btn btn-white" href="<?php echo $this->module?>cek_data_pasien" data-toggle='tooltip' title="Refresh">
