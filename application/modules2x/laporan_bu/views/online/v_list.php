...
<?php
	...
	$status[0]="<span class='label label-warning'>Baru</span>";
	$status[1]="<span class='label label-info'>Verifikasi</span>";
	$status[2]="<span class='label label-primary'>Terdaftar</span>";
	$status[99]="<span class='label label-danger'>DiTolak</span>";
?>
                        ...
                        <?php if(cek_array($arrData)):?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo strtoupper(GetBulan($val["bulan"]))?>  <?php echo $val["tahun"]?></td>
                                    <td>
										<?php echo $lookup_bnnp[$val["kd_bnn"]]?>
                                    </td>
                                    ...
                                    <td width="300px" style="padding:0">
                                    	<table class="table-bordered table-condensed table" style="margin-bottom:0;border:0px">
                                            ...
                                            <tr><td>ID</td><td><?=$val["jenis_identitas"]?> :<?php echo $val["no_identitas"]?></td></tr>
                                            <tr><td>Jenis Kelamin</td><td><?=$val["jenis_kelamin"]?></td></tr>
                                            <tr><td>Alamat</td><td><?php echo $val["alamat"]?></td></tr>
                                            
                                        </table>
									</td>
                                    
           							<td><?php echo $status[$val["status"]]?></td>                                    <td><?=$val["flag_konfirmasi"]?"Sudah":"Belum"?></td>
                                    <td><?=$val["flag_konfirmasi"]?date2indo($val["tgl_konfirmasi"]):"-"?></td>
                                    <td><?=$val["flag_konfirmasi"]?date2indo($val["jadwal_rekam_medis"]):"-"?></td>
                                    <td><?php echo $val["created"]?><br><?=$val["creator"]?></td>
                                     <td align="center">
