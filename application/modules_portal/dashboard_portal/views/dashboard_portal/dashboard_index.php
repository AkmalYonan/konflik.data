            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                      <h6 class="box-title" style="ext-transform:uppercase"><strong><span class="hidden-xs">DASHBOARD </span>SEBARAN KONFLIK & WILAYAH KELOLA</strong></h6>
                    </div>
    				<?php
						$req=get_post();
                    ...
                    <div class="col-md-6 col-xs-12">
    				  ...
    				  <div class="row">
                      		<div class="col-md-3 col-xs-12">
								<?=form_dropdown("tipe",$lookup_tipe,$tipe,"id='tipe' class='form-control select2 required'");?>
                            </div>
                            ...
                            <div class="col-md-2 col-xs-3">
                                <div class="checkbox">
                                <label class="pull-left <?=($selected_tahun?"":"not-used")?>" style="white-space:nowrap; line-height:38px">
                            ...
                            <button id="btn_search" type="submit" class="btn btn-default btn-block"><i class="fa fa-search"></i></button>
                            </div>
                      </div>
...
<ul class="nav nav-tabs">
	...
	<li class="">
		<a href="stats/wilayah_kelola/">
			<i class="fa fa-sitemap">&nbsp;</i>Wilayah Kelola
		</a>
	</li>
    <!-- <li class="">
        <a href="/stats/pesisir">
            <i class="fa fa-anchor">&nbsp;</i>Wilayah Pesisir
        </a>
    </li> -->
</ul>
                            ...
                            <div class="row">
                              <div class="col-md-12 border-right" >
                                <div class="panel-title">
                                    <h6> <span cstyle="border-radius: 0px !important;" class="label label-danger pull-right notif-box" data-display="konflik" title="Lihat Sebaran Konflik">Konflik <i class='fa fa-check-circle'></i></span></h6>
                                </div>
                                <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                  ...
                                  <h5 class="description-header">
                                  	<?=curr_format((float)$main['jumlah_konflik'],0)?>
                                    <?//=str_replace(",",".",number_format($main['jumlah_konflik']))?>
                                     </h5>
                                  <!--<span style="color:green">( number )</span><br />-->
                                  <span class="description-text">Jumlah Konflik <?=$tahun_data;?> </span>
                                  <br />
                                </div>
                            ...
                            <div class="col-md-4">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="dampak" title="Lihat Sebaran Dampak Konflik">Korban</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
                                      	<?=curr_format((float)$main['jumlah_dampak'],0)?>
                                        <?//=str_replace(",",".",number_format($main['jumlah_dampak']))?>
                                       </h5>
                                      <span class="description-text">Jumlah Korban (Jiwa)</span>
                                    </div>
                            ...
                            <div class="col-md-4">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-warning pull-right notif-box" data-display="lahan" title="Lihat Sebaran Luasan Lahan">Lahan</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important; border-right:1px solid #d6d6c2 ">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      ...
                                      <span class="description-text" title="Hektar (Ha)">Jumlah Luas Konfilk (Ha)</span>
                                    </div>
                            ...
                            <div class="col-md-3 hidden">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-success pull-right notif-box" data-display="investasi" title="Lihat Sebaran Nilai Investasi Konflik">Kerugian</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important; ">
                                      ...
                                      <span class="description-text" title="Rupiah">Nilai Kerugian (Rp.)</span>
                                    </div>
    	...
    	<div class="col-md-12">
            <div class="row">
                <div class="col-md-12" style="position:relative">
                	...
                	<div id="jml_tahun" style="height:80px; width:220px;" class="hides  hidden-xs"></div>
                	<h6 class="box-title hidden-xs" style="text-transform:uppercase; text-align:center"><small>JUMLAH KONFLIK PERTAHUN</small></h6>
                    </div>
                    <div class="map hidden-xs" style="background: transparent;width: 100%; height: 400px; margin-top:20px; margin-bottom:-20px"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8" style="position:relative">
                                ...
                                <div class="col-md-<?=(cek_array($top5_bl))?6:12?>">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <table class="table table-striped table-condensed tbl-fixed">
                                            ...
                                            <tr>
                                                <td><a target="_blank" href="data/konflik/?kd_prop=<?=$v['kd']?>&tahun=<?=$selected_tahun?>&tipe=<?=$tipe?>&bulan=<?=$selected_bulan?>&mmode=<?=$mmode?>"><?=$data_lookup[$level][$v['kd']]?></a></td>
                                    ...
                                    <div class="box-content">
                                        ...
                                        <? foreach($top5_bl as $k=>$v) :
                                          ...
                                          $total_luas+=$v['tot_luas'];?>
                                                <tr>
                                                    <td><a target="_blank" href="data/konflik/?sektor=<?=$k?>&tahun=<?=$selected_tahun?>&tipe=<?=$tipe?>&bulan=<?=$selected_bulan?>&mmode=<?=$mmode?>"><?=$v['nama']?></a></td>
                                                    <td><strong><?=$v['jumlah']?></strong></td>
                    ...
                    <div class="row">
                    	<div class="col-md-8">
                             <h6 class="box-title" style="text-transform:uppercase"><small>GRAFIK DATA KONFLIK <?=$time_title?></small></h6>
							  <div style="border-top:1px solid #ddd"></div>
							  <br /><br />
                             <div id="jml_per_bulan" style="height:180px" class="hides"></div>
                        </div>
						<div class="col-md-4">
                             <h6 class="box-title" style="text-transform:uppercase"><small>STATUS KONFLIK</small></h6>
							 <div style="border-top:1px solid #ddd"></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-9 col-xs-8">
                              <div class="product-info" style="text-align:left !important">
                                <a href="/data/konflik/detil/<?=$id?>">
                                <span class="product-title"><strong><?=$v['judul']?></strong></span></a>
                                    <br />
			...
			map = new jvm.Map({
				...
				series: {
				  ...
				  onRegionClick: function(event, code){
						...
						window.open("data/konflik?kd_prop="+code+"&tahun="+t+"&bulan="+b+"&tipe="+i+"&mmode="+k,'_blank');
						//window.open('data/konflik'+code, '_blank');
				  },
				  markerStyle:{
					  initial: {
						fill: 'orange',
