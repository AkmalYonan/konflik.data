                      ...
                      <div class="form-group col-xs-inline-block">
                        ...
                        <div class="checkbox">
                            <label class="<?=($selected_tahun?"":"not-used")?>">
                              <input id="mmode" type="checkbox" value="1"<?=$mmode?" checked":""?><?=($selected_tahun?"":" disabled='disabled'")?>> s/d Bulan
...
<ul class="nav nav-tabs">
	<li class="active">
		<a style="border-left:none !important;" href="stats/konflik/">
                            ...
                            <div class="col-md-3">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-success pull-right notif-box" data-display="investasi" title="Lihat Sebaran Nilai Investasi Konflik">investasi</span></h6>
                                    </div>
    	...
    	<div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-8" style="position:relative">
                    ...
                    <div class="row">
                    	<div class="col-md-8">
                             <h6 class="box-title" style="text-transform:uppercase"><small>GRAFIK DATA KONFLIK PERBULAN</small></h6>
							  <div style="border-top:1px solid #ddd"></div>
							  <br /><br />
						...
						<div class="col-md-4">
							 ...
							 <div style="border-top:1px solid #ddd"></div>
                             <div id="chart4" style="height:250px;text-align:'center' !important"></div>
                        </div>
                    </div>
                </div>
