            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-9">
                      <form class="form-inline" action="<?=$this->module?><?=$wstatus?>" method="get" style="float:right !important">
        ...
        <div class="col-md-12">
            ...
            <div class="row" style="margin-top:2px;">
                <div class="col-md-12" style="border-bottom:1px solid #ddd; padding-bottom:15px">
                    <a href="<?=$this->module?><?=$param?>" class="btn btn-default <?=!$wstatus?'active':''?>">Semua</a> 
                    <a href="<?=$this->module?>potensi<?=$param?>" class="btn btn-default <?=$wstatus=='potensi'?'active':''?>">Potensi</a> 
                    <a href="<?=$this->module?>usulan<?=$param?>" class="btn btn-default <?=$wstatus=='usulan'?'active':''?>">Usulan</a> 
                    <a href="<?=$this->module?>realisasi<?=$param?>" class="btn btn-default <?=$wstatus=='realisasi'?'active':''?>">Realisasi</a>
                </div>
            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12 border-right" >
                                <div class="panel-title">
                                    <h6> <span cstyle="border-radius: 0px !important;" class="label label-danger pull-right notif-box" data-display="konflik" title="Lihat Sebaran Wilayah Kelola">Total <i class='fa fa-check-circle'></i></span></h6>
                                </div>
                                <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                  ...
                                  <span class="description-text">Total Wilayah</span>
                                  <br />
                                </div>
                            ...
                            <div class="col-md-2">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="piaps" title="Sebaran Wilayah PS">PS</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
                                      ...
                                      <span class="description-text">Jumlah Perhutanan Sosial</span>
                                    </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    ...
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      ...
                                      <span class="description-text">Jumlah Hutan Adat</span>
                                    </div>
                            ...
                            <div class="col-md-2">
                              <div>
                                <div class="row">
                                  <div class="col-md-12 border-right" >
                                    <div class="panel-title">
                                        <h6> <span style="border-radius: 0px !important;" class="label label-info pull-right notif-box" data-display="pppbm" title="PPPBM">PPPBM</span></h6>
                                    </div>
                                    <div class="description-block" style="text-align:left !important;border-right:1px solid #d6d6c2">
                                      <span class="description-percentage text-green hidden"><i class="fa fa-caret-up"></i> 0%</span>
                                      <h5 class="description-header">
                                        <!-- <?pre($main['ha']);?> -->
                                        <?=curr_format((float)$main['pppbm'],0)?>
                                        <?//=str_replace(",",".",number_format($main['jumlah_dampak']))?>
                                       </h5>
                                      <span class="description-text">Jumlah PPPBM</span>
                                    </div>
                                ...
                                <div class="col-md-<?=(cek_array($top5_bl))?6:12?>">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <table class="table table-striped table-condensed tbl-fixed">
                                            ...
                                            <tr>
                                                <td><a target="_blank" href="data/wilayah_kelola/?kd_prop=<?=$v['kd']?>&tahun=<?=$selected_tahun?>&tipe=<?=$tipe?>&bulan=<?=$selected_bulan?>&mmode=<?=$mmode?>"><?=$data_lookup[$level][$v['kd']]?></a></td>
                                    ...
                                    <div class="box-content">
                                        ...
                                        <? foreach($top5_bl as $k=>$v) :
                                          ...
                                          $total_luas+=$v['tot_luas'];?>
                                                <tr>
                                                    <td><a target="_blank" href="data/wilayah_kelola/?jenis_wikera=<?=$k?>&tahun=<?=$selected_tahun?>&tipe=<?=$tipe?>&bulan=<?=$selected_bulan?>&mmode=<?=$mmode?>"><?=$jenis_wikera[$v['nama']]?></a></td>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-9 col-xs-8">
                              <div class="product-info" style="text-align:left !important">
                                <a href="/data/wilayah_kelola/detil/<?=$id?>">
...
<script>
    ...
    var data_pppbm={id:<?=$jml_wil_pppbm['id']?json_encode($jml_wil_pppbm['id'],true):'false'?>,id_pop:<?=$jml_wil_pppbm['id_pop']?json_encode($jml_wil_pppbm['id_pop'],true):'false'?>,blbb:<?=$jml_wil_pppbm['blbb']?json_encode($jml_wil_pppbm['blbb'],true):'false'?>,colors:<?=json_encode($jml_wil_pppbm['colors'])?>};
