                    ...
                    <div class="col-md-6 col-xs-9">
                      ...
                      <div class="form-group col-xs-inline-block">
											<div class="form-group col-xs-inline-block">
													...
													?>
													<?=form_dropdown("tipe",$lookup_tipe,$tipe,"id='tipe' style='width:110px !important' class='form-control select2 required'");?>
                        ...
                        <div class="form-group">
                          ...
                          <select id="bulan" name="bulan" style="width:75px !important;" class="form-control <?=($selected_tahun?"":"not-used")?>"<?=($selected_tahun?"":" disabled='disabled'")?>>
                            ...
                            <div class="col-md-9 col-xs-8">
                              <div class="product-info" style="text-align:left !important">
                                <span class="product-title"><strong><?=$v['judul']?></strong></span>
									...
									<span  style="font-size:11px;">
										Luas : <?=number_format($v['luas'])?> Ha, Tahapan : <?=$tahapan[$v["kode_tahapan"]]?>
                                    </span>
                              </div>
                            </div>
                          </div>
