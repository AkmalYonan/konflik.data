	...
	<div class="row">
    	<div class="col-md-12">
            ...
            <ul class="nav nav-tabs nav-justified" id="myTabs" role="tablist" style=" position:relative;margin-bottom:10px;"> 
                <li class="active"><a href="<?=$this->module?>">SUMMARY</a></li>
            ...
            <?
				...
				$n_do = number_format($sp_do,0,".",".");	
				$p_do = number_format(($sp_do/$jumlah)*100,2,".",".");	
				...
				$n_md = number_format($sp_md,0,".",".");	
				$p_md = number_format(($sp_md/$jumlah)*100,2,".",".");	
				...
				$nama_wilayah = $kd_org?$lookup_wilayah[$kd_org]:($tipe_instansi=='BL'?"Seluruh Balai/Loka":($tipe_instansi=='BNNP'?"Seluruh Wilayah Propinsi":"Seluruh Wilayah"));
			?>
			
            <!-- MAP -->
            <div class="row">
                <div class="col-md-12" style="position:relative">
                	<div style="position:absolute; top:120px; height:100px; right:60px; font-size:150px; line-height:100px; color:rgba(100,100,100,0.1)"><?=$selected_tahun?></div>
                	<div style="position:absolute; top:160px; right:80px; font-size:40px; color:rgba(100,100,100,0.2)"><?=$selected_bulan?$listMonth[$selected_bulan-1]:""?></div>
                        
                	<div class="box-header with-borders" style="background:rgba(255,255,255,.6); margin-top:-8px">
                    	<div class="row">
                        	<div class="col-md-3">
                            	<h3 class="box-title" style="text-transform:uppercase"><strong>DASHBOARD STATUS REHAB</strong></h3>
                            ...
                            <div class="col-md-3">
                            	<h3 class="box-title" style="text-transform:uppercase">DATA PERTAHUN</h3>
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-md-4">
                                    	<table style="width:100%">
                                            <!--<tr class="text-aqua">
                                                <td><h3 class="box-title">ASSESMENT</h3></td><td class="box-title"><span class="badge badge-status bg-aqua"><?=$n_assesment;?></span></td><td><small><?=$p_assesment?>%</small></td>
                                            </tr>-->
                                            <tr class="text-red">
                                                <td><h3 class="box-title text-purple">REHABILITASI</h3></td><td class="box-title"><span class="badge badge-status bg-purple"><?=$n_rehab;?></span></td><!--<td><small><?=$p_rehab?>%</small></td>-->
                                            </tr>
                                            <tr class="text-red">
                                                <td><h3 class="box-title text-red">DROP OUT</h3></td><td class="box-title"><span class="badge badge-status bg-red"><?=$n_do;?></span></td><!--<td><small><?=$p_rehab?>%</small></td>-->
                                            </tr>
                                            <tr class="text-orange">
                                                <td><h3 class="box-title text-orange">PASCA</h3></td><td class="box-title"><span class="badge badge-status bg-orange"><?=$n_pasca;?></span></td><!--<td><small><?=$p_pasca?>%</small></td>-->
                                            </tr>
                                            <tr class="text-green">
                                                <td><h3 class="box-title text-green">OUTCOME</h3></td><td class="box-title"><span class="badge badge-status bg-green"><?=$n_selesai;?></span></td><!--<td><small><?=$p_selesai?>%</small></td>-->
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-4">
                                    	<table style="width:100%">
                                            <tr class="text-orange">
                                                <td><h3 class="box-title text-muted">MENINGGAL</h3></td><td class="box-title"><span class="badge badge-status bg-gray"><?=$n_md;?></span></td><!--<td><small><?=$p_pasca?>%</small></td>-->
                                            </tr>
                                            
                                        </table>
                                    </div>
                                    <div class="col-md-3 text-orange">
                                        <div id="pie_0" class="hide" style="height:100px;width:100%"></div>
                                    </div>
                                </div>
                            ...
                            <!--<div class="col-md-6">
                            	<div class="row">
                                    ...
                                    <div class="col-md-3 text-red">
                                    	<h3 class="box-title">REHAB</h3>
                                        <div class="info-top"><?=$n_rehab;?>
                                        <small><?=$p_rehab?>%</small></div>
                                    </div>
                                    <div class="col-md-3 text-orange">
                                    	<h3 class="box-title">PASCA</h3>
                                        <div class="info-top"><?=$n_pasca;?>
                                        <small><?=$p_pasca?>%</small></div>
                                    </div>
                                    <div class="col-md-3 text-green">
                                    	<h3 class="box-title">SELESAI</h3>
                                        <div class="info-top"><?=$n_selesai;?>
                                        <small><?=$p_selesai?>%</small></div>
                                    </div>
                                </div>
            ...
            <div class="box box-widget hidden">
            	<div class="box-header with-borders"  style="position:absolutes; z-index:10000">
                	<div class="row">
                        <div class="col-md-8">
                            <h3 class="box-title">PASIEN REGISTRASI PER BULAN</h3>
                        </div>
                        <div class="col-md-4">
                	...
                	<div class="row">
                        <div class="col-md-8" style="position:relative">
                            <div class="progress-group">
                                    <span class="progress-text">Pulih Produktif (<?=$pulih_produktif;?>)</span>
                                    <span class="progress-number"><b><?=$pp?>%</b></span>
                
                                    <div class="progress xs">
                                      <div class="progress-bar progress-bar-green" style="width: <?=$pp?>%"></div>
                                    </div>
                                  </div>
                                  <!-- /.progress-group -->
                                  <div class="progress-group">
                                    <span class="progress-text">Pulih, Tidak Produktif (<?=$pulih_tidak_produktif;?>)</span>
                                    <span class="progress-number"><b><?=$ptp?>%</b></span>
                
                                    <div class="progress xs">
                                      <div class="progress-bar progress-bar-aqua" style="width: <?=$ptp?>%"></div>
                                    </div>
                                  </div>
                                  <!-- /.progress-group -->
                                  <div class="progress-group">
                                    <span class="progress-text">Tidak Pulih, Produktif (<?=$tidak_pulih_produktif;?>)</span>
                                    <span class="progress-number"><b><?=$tpp?>%</b></span>
                
                                    <div class="progress xs">
                                      <div class="progress-bar progress-bar-yellow" style="width: <?=$tpp?>%"></div>
                                    </div>
                                  </div>
                                  <!-- /.progress-group -->
                                  <div class="progress-group">
                                    <span class="progress-text">Tdk Pulih, Tdk Produktif (<?=$tidak_pulih_tidak_produktif;?>)</span>
                                    <span class="progress-number"><b><?=$tptp?>%</b></span>
                
                                    <div class="progress xs">
                                      <div class="progress-bar progress-bar-red" style="width: <?=$tptp?>%"></div>
                                    </div>
                                  </div>
                                  <!-- /.progress-group -->
                        </div>
...
$(document).ready(function(){
	...
	var plot_pie_0 = plot_pie("pie_0",data_p0,{"color":["#05c1ef","#dd4b39","#ff851b","#1db06d"]});
