...
L.Control.GroupedLayers = L.Control.extend({
  ...
  removeLayer: function (layer) {
    var id = L.Util.stamp(layer);alert(id);
  ...
  _initLayout: function () {
    ...
    if (this.options.collapsed) {
      ...
      link.href = '#';
      link.title = 'Layers';
	  link.text = this.options.label;
	  if (this.options.fa) {
		var fa =L.DomUtil.create('i', 'fa fa-'+this.options.fa);
		link.appendChild(fa);  
	  }
  ...
  _expand: function () {
    ...
    var acceptableHeight = this._map._size.y - (this._container.offsetTop * 3);
